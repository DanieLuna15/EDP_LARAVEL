        ...
        <div class="page-header">
            <div class="page-title">
                <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid">
                    ...
                    </svg> Configuración / Formas de pago</p>
            </div>
            ...
            methods: {
                async Save() {
                    try {
                        ...
                        let url = "{{url('api/formapagos')}}";
                        if (this.add == false) {
                            url = "{{url('api/formapagos')}}/"+this.model.id
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/formapagos')}}")]).then((v) => {
                                self.data = v[0]
                            })
