                                ...
                                <div class="modal-body">
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" v-model="model.titular" class="form-control"
                                                placeholder="Titular">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail4">Cuenta</label>
                                            <input type="text" v-model="model.cuenta" class="form-control" placeholder="Cuenta">
                                        </div>
                ...
                methods: {
                    async Save() {
                        try {
                            ...
                            let url = "{{ url('api/bancos') }}";
                            if (this.add == false) {
                                url = "{{ url('api/bancos') }}/" + this.model.id
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/bancos') }}")]).then((v) => {
                                    self.data = v[0]
                                })
