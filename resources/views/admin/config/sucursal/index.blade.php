...
<div id="block_ui">
    <div class="action-btn layout-top-spacing mb-5">
        <div class="page-header">
            ...
            <a href="./sucursal/add" class="btn btn-success">Agregar</a>
        </div>
            ...
            <table id="table_dt" class="table table-hover non-hover" style="width:100%">
              ...
              <tbody>
                <tr v-for="(m,i) in data">
                  ...
                  <td>
                    <div class="btn-group">
                      <a :href="'./sucursal/edit/'+m.id" class="btn btn-warning btn-sm">Editar</a>
                      ...
                      <a :href="'./sucursal/image/'+m.id" class="dropdown-item">Imagen</a>
            ...
            methods: {
                async Save() {
                    try {
                        ...
                        let url = "{{url('api/sucursals')}}";
                        if (this.add == false) {
                            url = "{{url('api/sucursals')}}/"+this.model.id
