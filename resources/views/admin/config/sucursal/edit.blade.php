              ...
              <div class="row">
                ...
                <div class="col-sm-3 col-6">
                  <div class="form-group">
                    ...
                    <input type="text" v-model="model.email" class="form-control mb-4" placeholder="">
                  </div>
                </div>
                <div class="col-sm-3 col-6">
                  <div class="form-group">
                ...
                <div class="col-sm-4 col-6">
                  <div class="form-group">
                    ...
                    <input type="text" v-model="model.responsable" class="form-control mb-4" placeholder="">
                  </div>
                </div>
                <div class="col-sm-4 col-6">
                  <div class="form-group">
                    <label for="fullName">Medidor</label>
                    <input type="text" v-model="model.medidor" class="form-control mb-4" placeholder="">
                  </div>
                </div>
                <div class="col-6">
    ...
    methods: {
      ...
      async Save() {
        ...
        try {
          ...
          let url = "url_path()api/sucursals";
         await axios.put("{{url('api/sucursals')}}/{{$id}}",this.model)
          this.back()
    ...
    mounted() {
      this.$nextTick(async () => {
        ...
        try {
          ...
          await Promise.all([self.GET_DATA('documentos'),self.GET_DATA("sucursals/{{$id}}")]).then((v) => {
            self.documentos = v[0]
            self.model = v[1]
          })
