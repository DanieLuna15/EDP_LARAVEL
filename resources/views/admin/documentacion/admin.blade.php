        ...
        <div class="page-header">
            <div class="page-title">
                <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid">
                    ...
                    </svg> Documentacion / Administracion</p>
            </div>
                    ...
                    <div class="modal-body">
                        <div class="form-row mb-4">
                            ...
                            <div class="form-group col-md-12">
                               ...
                               <textarea name="description" v-model="model.descripcion" class="form-control" id=""></textarea>
                            </div>
                        </div>
                    </div>
            ...
            methods: {
                async Save() {
                    try {
                        ...
                        let url = "{{url('api/documentacions')}}";
                        if (this.add == false) {
                            url = "{{url('api/documentacions')}}/"+this.model.id
                    ...
                    swalWithBootstrapButtons({
                        ...
                        if (result.value) {
                            try {
                                ...
                                let url = "{{url('api/documentacions')}}/"+id
