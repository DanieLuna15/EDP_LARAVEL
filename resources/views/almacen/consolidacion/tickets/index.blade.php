        ...
        <div class="page-header">
            <div class="page-title">
                <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid">
                    ...
                    </svg> Consolidacion / Pagos de Lote</p>
            </div>
            <a href="./tickets/add" class="btn btn-success">Pagar Consolidaciones Lote</a>
        </div>
              ...
              <tbody>
                <tr v-for="(m,i) in data">
                  ...
                  <td>
                    ...
                    <span v-else class="badge bg-primary">{{m.consolidacion_pago.suma_total==m.consolidacion_pago.adelanto?'CREDITO PAGADO':'CREDITO'}}</span>
                  </td>
                  <td>
                  ...
                  <td>
                    <div class="btn-group">
                      <a :href="m.url_pdf" class="btn btn-primary btn-sm">TICKET</a>
                      ...
                      <a :href="m.consolidacion_pago.url_pdf" class="dropdown-item">Historico</a>
            ...
            methods: {
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/consolidacionPagoTickets')}}")]).then((v) => {
                                self.data = v[0]
                            })
