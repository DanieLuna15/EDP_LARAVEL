        ...
        <div class="page-header">
            <div class="page-title">
                <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid">
                    ...
                    </svg> Almacen / Parametros de consolidacion</p>
            </div>
                    ...
                    <div class="modal-body">
                        <div class="form-row mb-4">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" v-model="model.monto" class="form-control" placeholder="Monto">
                            </div>
            ...
            methods: {
                async Save() {
                    try {
                        ...
                        let url = "{{url('api/consolidacionparams')}}";
                        if (this.add == false) {
                            url = "{{url('api/consolidacionparams')}}/"+this.model.id
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/consolidacionparams')}}")]).then((v) => {
                                self.data = v[0]
                            })
                    ...
                    swalWithBootstrapButtons({
                        ...
                        if (result.value) {
                            try {
                                ...
                                let url = "{{url('api/consolidacionparams')}}/"+id
