            ...
            <div class="row">
                  ...
                  <div class="input-group mb-4">
                    ...
                    <select v-model="lote" class="form-control">
                      ...
                      <template v-for="(m,i) in consolidacions.reverse()">
                        ...
                        <option v-if="m.consolidacion_pago_detalle==null" :value="m"> {{ m . fecha }} - Consolidación: {{ m . id }} - Lote: {{ m . compra . nro_compra }}</option>
              ...
              <div class="col-sm-2 col-12 m-4">
                <div class="form-group">
                  ...
                  <input :value="Number(SumValor).toFixed(2)" disabled type="text" class="form-control mb-4">
                </div>
              </div>
                  ...
                  <div class="col-12">
                    <div class="row">
                      <div class="col-3 ">
                        ...
                        <select class="form-control" v-model="pago.tipo" @change="pago.adelanto=pago.tipo==1?SumValor:0">
                      ...
                      <div class="col-3 ">
                        <div class="form-group">
                          ...
                          <input value="" type="text" v-bind:disabled="pago.tipo==1" v-model.number="pago.adelanto" class="form-control mb-4">
                        </div>
                      </div>
                      <div class="col-3 ">
                      ...
                      <div class="col-3 ">
                        <div class="form-group">
                          ...
                          <input value="" v-model="pago.fecha" v-bind:disabled="pago.tipo==1" type="date" class="form-control mb-4">
                        </div>
                      </div>
                      <div class="col-6 ">
                      ...
                      <div class="col-6 ">
                        <div class="form-group">
                          ...
                          <input value="" type="text"  v-model="pago.observaciones" class="form-control mb-4">
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    methods: {
      ...
      async Save() {
        ...
        try {
          ...
          let res = await axios.post("{{url('api/consolidacionPagos')}}", this.pago)
    ...
    mounted() {
      this.$nextTick(async () => {
        ...
        try {
          ...
          await Promise.all([self.GET_DATA('consolidacions'), self.GET_DATA('consolidacionParams'), self.GET_DATA('productos'), self.GET_DATA('almacens'), self.GET_DATA('bancos'),
