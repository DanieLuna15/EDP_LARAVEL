                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-row mb-4">
                            ...
                            <div class="form-group col-md-12">
                                <label for="inputEmail4">Retraccion</label>
                                <input type="text" v-model="model.retraccion" class="form-control" placeholder="Retraccion">
                            </div>
            ...
            methods: {
                async Save() {
                    try {
                        ...
                        let url = "{{url('api/medidas')}}";
                        if (this.add == false) {
                            url = "{{url('api/medidas')}}/"+this.model.id
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/medidas')}}")]).then((v) => {
                                self.data = v[0]
                            })
