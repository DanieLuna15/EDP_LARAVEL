            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row mb-4">
                            <div class="form-group col-md-12">
                                <label for="inputEmail4">Manejo de cinta</label>
                                <select v-model="model.cinta" class="form-control"   name="" id="">
            ...
            methods: {
                async Save() {
                    try {
                        ...
                        let url = "{{url('api/categorias')}}";
                        if (this.add == false) {
                            url = "{{url('api/categorias')}}/"+this.model.id
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/categorias')}}")]).then((v) => {
                                self.data = v[0]
                            })
