                                            ...
                                            <div v-else class="row">
                                                <div v-for="(l,i) in categoriaList"
                                                    ...
                                                    <div class="card" v-for="m in l.categoria_proveedor_list">
                                                        <div class="card-body">
                                                            <h6>{{ m . categoria . name }} N° Compra:
                                                                {{ l . proveedor_compra . abreviatura }} {{ l . nro_compra }} - Lote
                                                                N°:
                                                                {{ l . nro }} - Fecha: {{ l . fecha }} - Proveedor:
                                                                {{ l . proveedor_compra . nombre }} </h6>
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="td-c">
                                                                                        <input v-model="m.proveedor" type="text"
                                                                                            class="fm-ct form-control" required
                                                                                    ...
                                                                                    <td class="td-c"> <input
                                                                                            v-model.number="m.precio" disabled
                                                                                            type="text"
                                                                                            class="fm-ct form-control "></td>
                                                                                    <td class="td-c">
                                                                                        {{ Number(m . ajuste) . toFixed(2) }}
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="row bg-dark p-2">
                                                        ...
                                                        <div class="col-sm-2 col-12 m-4">
                                                            <div class="form-group">
                                                                <label for="fullName">Total de Aves</label>
                    ...
                    categoriaList() {
                        ...
                        return this.lotes.map((lote) => {
                            lote.categoria_proveedor_list.forEach((item) => {
                                ...
                                // Calculando el precio de compra usando sumaPollos para el cálculo
                                let totalPollos = Number(item.sumaPollos) ||
                                    0; // Asegurarnos de que no sea NaN
                    ...
                    async GetLote() {
                        ...
                        try {
                            ...
                            this.lotes.forEach(lote => {
                                lote.categoria_proveedor_list.forEach(item => {
                                    if (item.lp === undefined || item.lp === null) {
                                        item.lp = 0.000;
                                    }
                                });
                            });
                    ...
                    async Save() {
                        ...
                        try {
                            for (let l of this.categoriaList) {
                                for (let m of l.categoria_proveedor_list) {
                                    if (!m.proveedor || m.proveedor.trim() === "") {
                                        alert("ERROR: Proveedor vacío en lote:\n" + JSON.stringify(m, null, 2));
                                        swal({
                                            title: 'Error',
                                    ...
                                    if (isNaN(m.cantidad_jaulas) || m.cantidad_jaulas <= 0) {
                                        alert("ERROR: Cantidad de jaulas inválida en lote:\n" + JSON.stringify(m,
                                            null, 2));
                                        swal({
                                            title: 'Error',
                                            text: 'La cantidad de jaulas debe ser mayor a 0.',
                                            type: 'error',
                                            confirmButtonText: 'OK'
                                        });
                                        block.unblock();
                                    ...
                                    if (m.lp === undefined || m.lp < 0) {
                                        alert("ERROR: LP inválido en lote:\n" + JSON.stringify(m, null, 2));
                                        swal({
                                            title: 'Error',
                                            text: 'El campo LP debe tener un valor igual o mayor a 0.',
                                            type: 'error',
                                            confirmButtonText: 'OK'
                                        });
                                        return;
                            ...
                            swal({
                                ...
                                text: "<pre style='text-align:left;white-space:pre-wrap;'>" + JSON
                                    .stringify(this.gastosFinales, null, 2) + "</pre>",
                                html: true,
                                customClass: 'swal-wide'
                            });

                            swal({
                                title: "Parametro de consolidacion",
                                text: "<pre style='text-align:left;white-space:pre-wrap;'>" + JSON
                                    .stringify(this.paramConsolidacion, null, 2) + "</pre>",
                                html: true,
                                customClass: 'swal-wide'
                            });
                            ...
                            swal({
                                ...
                                text: "<pre style='text-align:left;white-space:pre-wrap;'>" + this
                                    .valorTotalFinal + "</pre>",
                                html: true
                            });
                            ...
                            swal({
                                title: "Peso total",
                                text: "<pre style='text-align:left;white-space:pre-wrap;'>" + this.SumPeso +
                                    "</pre>",
                                html: true
                            });
                            ...
                            swal({
                                ...
                                text: "<pre style='text-align:left;white-space:pre-wrap;'>" + JSON
                                    .stringify(this.categoriaList, null, 2) + "</pre>",
                                html: true,
                                customClass: 'swal-wide'
                            });
                            ...
                            swal({
                                title: "Pago",
                                text: "<pre style='text-align:left;white-space:pre-wrap;'>" + JSON
                                    .stringify(this.pago, null, 2) + "</pre>",
                                html: true,
                                customClass: 'swal-wide'
                            });
