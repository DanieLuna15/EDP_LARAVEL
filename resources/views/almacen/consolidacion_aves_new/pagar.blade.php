                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                </svg> Almacen / Pago de lotes de aves </p>
                        </div>
                        <a href="./pagar-ave-new/add" class="btn btn-success">Pagar Compras de Aves</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <tbody>
                                        <tr v-for="(m,i) in data">
                                            ...
                                            <td>
                                                ...
                                                <span v-else
                                                    class="badge bg-primary">{{ m . suma_total == m . adelanto ? 'CREDITO PAGADO' : 'CREDITO' }}</span>
                                            </td>
                                            <td>{{ m . suma_total }}</td>
                ...
                methods: {
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/consolidacionAveNewPagos') }}")]).then((
                                    v) => {
                                    self.data = v[0]
                                })
                        ...
                        swalWithBootstrapButtons({
                            ...
                            if (result.value) {
                                try {
                                    ...
                                    let url = "{{ url('api/consolidacionAveNewPagos') }}/" + id
