            ...
            <div id="block_ui">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-2" align="right">
                        ...
                        <button v-if="activeEstado" class="btn btn-danger" @click="LimpiarEstadosPollos"
                            title="Limpiar estados">
                            <i class="fas fa-trash-alt"></i>
                        </button>
                    </div>
                                    ...
                                    <tbody>
                                        <template v-for="(item,i) in itemsPollos">
                                            ...
                                            <tr class="bg-light-primary" v-if="activeDescuento==true">
                                                ...
                                                <td></td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" v-model="item.descuento_1" @blur="validarDescuento(item, 'desc1')">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" v-model="item.descuento_2" @blur="validarDescuento(item, 'desc2')">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" v-model="item.descuento_3" @blur="validarDescuento(item, 'desc3')">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" v-model="item.descuento_4" @blur="validarDescuento(item, 'desc4')">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" v-model="item.descuento_alternativo_1" @blur="validarDescuento(item, 'desca1')">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" v-model="item.descuento_alternativo_2" @blur="validarDescuento(item, 'desca2')">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" v-model="item.descuento_alternativo_3" @blur="validarDescuento(item, 'desca3')">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" v-model="item.descuento_alternativo_4" @blur="validarDescuento(item, 'desca4')">
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr class="bg-light-success" v-if="activeEstado">
                                                ...
                                                <td>
                                                    <label class="radio-estado">
                                                        <input type="radio" :name="'estado_precio_alternativo_' + item.id" v-model="item.precio_estado_seleccionado" :value="1">
                                                        <span>Activo</span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label class="radio-estado">
                                                        <input type="radio" :name="'estado_precio_alternativo_' + item.id" v-model="item.precio_estado_seleccionado" :value="2">
                                                        <span>Activo</span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label class="radio-estado">
                                                        <input type="radio" :name="'estado_precio_alternativo_' + item.id" v-model="item.precio_estado_seleccionado" :value="3">
                                                        <span>Activo</span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label class="radio-estado">
                                                        <input type="radio" :name="'estado_precio_alternativo_' + item.id" v-model="item.precio_estado_seleccionado" :value="4">
                                                        <span>Activo</span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <label class="radio-estado">
                                                        <input type="radio" :name="'estado_precio_' + item.id" v-model="item.precio_estado_seleccionado" :value="null">
                                                        <span>Ninguno</span>
                                                    </label>
                                                </td>
                                        </tr>
                    ...
                    <div class="col-lg-12 mt-2" align="right">
                        ...
                        <button v-if="activeEstado" class="btn btn-danger" @click="LimpiarEstadosTransformacionesEspeciales"
                            title="Limpiar estados">
                            <i class="fas fa-trash-alt"></i>
                        </button>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <template v-for="(td,si) in t.trans_especial_items">
                                                <tr>
                                                 ...
                                                 <tr class="bg-light-info" v-if="activeEstado">
                                                        <td colspan="5"></td>
                                                        <td>
                                                            <label class="radio-estado">
                                                                <input type="radio" :name="'estado_precio_alternativo_' + td.id" v-model="td.precio_estado_seleccionado" :value="1">
                                                                <span>Activo</span>
                                                            </label>
                                                        </td>
                                                        <td>
                                                            <label class="radio-estado">
                                                                <input type="radio" :name="'estado_precio_alternativo_' + td.id" v-model="td.precio_estado_seleccionado" :value="2">
                                                                <span>Activo</span>
                                                            </label>
                                                        </td>
                                                        <td>
                                                            <label class="radio-estado">
                                                                <input type="radio" :name="'estado_precio_alternativo_' + td.id" v-model="td.precio_estado_seleccionado" :value="3">
                                                                <span>Activo</span>
                                                            </label>
                                                        </td>
                                                        <td>
                                                            <label class="radio-estado">
                                                                <input type="radio" :name="'estado_precio_alternativo_' + td.id" v-model="td.precio_estado_seleccionado" :value="4">
                                                                <span>Activo</span>
                                                            </label>
                                                        </td>
                                                        <td>
                                                            <label class="radio-estado">
                                                                <input type="radio" :name="'estado_precio_' + td.id" v-model="td.precio_estado_seleccionado" :value="null">
                                                                <span>Ninguno</span>
                                                            </label>
                                                        </td>
                                                    </tr>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-weight: bold;color:red">{{ t . promedio_item }}</td>
                                                    <td>
                                                    <td colspan="5"><button type="button" class="btn btn-danger btn-sm0" align="center"
                    ...
                    <div class="col-lg-12 mt-2" align="right">
                        ...
                        <button v-if="activeEstado" class="btn btn-danger" @click="LimpiarEstadosTransformaciones"
                            title="Limpiar estados">
                            <i class="fas fa-trash-alt"></i>
                        </button>
                    </div>
            ...
            createApp({
                ...
                methods: {
                    ...
                    async SaveTransformaciones() {
                        try {
                            let data = {
                                transformaciones: this.Transformacion1.map(function(t) {
                                    return {
                                        ...t,
                                        trans_item_detalles: t.trans_item_detalles.map(function(td) {
                                            return {
                                                ...td,
                                ...
                                trans_items: this.Transformacion2.map(function(t) {
                                    return {
                                        ...t,
                                        trans_item_detalles: t.trans_item_detalles.map(function(td) {
                                            return {
                    ...
                    async saveTransformacionesEspeciales() {
                        try {
                            ...
                            let data = {
                                transformaciones: this.TransformacionEspecial1.map(function(t) {
                                    return {
                                        ...t,
                                        trans_especial_items: t.trans_especial_items.map(function(td) {
                                            return {
                                                ...td,
                                ...
                                trans_especials: this.TransformacionEspecial2.map(function(t) {
                                    return {
                                        ...t,
                                        trans_especial_items: t.trans_especial_items.map(function(td) {
                                            return {
