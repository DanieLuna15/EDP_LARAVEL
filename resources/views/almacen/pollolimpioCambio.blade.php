        ...
        <div class="page-header">
            <div class="page-title">
                <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid">
                    ...
                    </svg> Cambio de precio de pollo Limpio</p>
            </div>
            ...
            methods: {
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/pollolimpioCambiosFecha')}}")]).then((v) => {
                                self.data = v[0]
                            })
                ...
                async ConsultarFecha(){
                    ...
                    try {
                        ...
                        dt.destroy()
                        let res = await axios.post("{{url('api/pollolimpioCambiosFecha')}}",data).then((v) => {
                                self.data = v.data
                            })
