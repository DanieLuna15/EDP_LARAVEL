        ...
        <div class="page-header">
            <div class="page-title">
                <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid">
                    ...
                    </svg> Almacen / Compras Anuladas</p>
            </div>
            <div>
                <a :href="urlAdd" class="btn btn-success">Nueva Compra Lote</a>
                <a :href="urlIndex" class="btn btn-info">Compras Vigentes</a>
                <a :href="urlCerradas" class="btn btn-danger">Compras Cerradas</a>
            </div>
        </div>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu" :aria-labelledby="'menu'+i">
                        ...
                        <a class="dropdown-item" href="javascript:void(0)" @click="deleteItem(m.id)" style="display: none">Eliminar</a>
...
<script>
    ...
    window.urlIndex = "{{ url('/almacen/compras') }}";
            ...
            methods: {
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/compras-anuladas')}}")]).then((v) => {
                                self.data = v[0]
                            })
