        ...
        <div class="col-lg-12 col-12">
            <div class="widget-content widget-content-area br-6">
                <div class="section general-info">
                    <div class="info">
                        <h5 class="">Ingrese los datos para la Compra de un Lote</h5>
                        <div class="row">
                            ...
                            <div class="col-12">
                                <hr>
                                <h5 class="">Ingrese datos de caja(s)</h5>
                            </div>
                            <div class="col-sm-3 col-12">
                                <div class="form-group">
                                    <label for="fullName">Cantidad de cajas</label>
                                    <input v-model="producto_model.cantidad" @input="validarCinta()"
                            ...
                            <div class="col-sm-3 col-12">
                                <div class="form-group">
                                    ...
                                    <input v-model="producto_model.peso" @input="validarCinta()" type="text"
                                        class="form-control mb-4">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3 col-12">
                                <div class="form-group">
                                    ...
                                    <select name="" id="" class="form-control" v-model="cinta"
                                        @change="CambiarCinta" :disabled="producto.tipo == 0">
                                    ...
                                    <div v-if="cintaError" class="text-danger mt-2">
                                        No se ha encontrado una cinta compatible en base a los parametros ingresados.
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table id="table_dt" class="table table-hover non-hover" style="width:100%">
                                        ...
                                        <tfoot>
                                            <tr class="table-default">
                                                ...
                                                <td colspan="6" class="text-left bg-white text-black">
                                                    {{ SumCantPollos }}
                                                </td>
                                            </tr>
                                            <tr class="table-default">
...
<script type="module">
    ...
    createApp({
        ...
        methods: {
            ...
            validarCinta() {
                if (this.producto_model.cantidad && this.producto_model.peso) {
                    let medidas = {
                        ...this.medida_producto
                    };
                    ...
                    if (!unit) {
                        this.cintaError = true;
                    } else {
                        this.cintaError = false;
                    }
                }
            },
            ...
            AgregarProducto() {
                ...
                if (!unit) {
                    ...
                    swalWithBootstrapButtons({
                        title: 'Error!',
                        text: "No se puede agregar el producto porque no tiene cinta seleccionada.",
                        type: 'error',
                        showCancelButton: false,
                        confirmButtonText: 'OK',
                        padding: '2em',
