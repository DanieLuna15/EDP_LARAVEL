                    ...
                    <div class="col-lg-12 col-12">
                        <div class="widget-content widget-content-area br-6">
                            <div class="section general-info">
                                <div class="info">
                                    <h6 class="">Ingrese los datos para la Compra de un Lote de Aves</h6>
                                    <div class="row">
                                                ...
                                                <table id="table_dt" class="table table-hover non-hover" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(m,i) in productos_model_computed">
                                                            ...
                                                            <td style="display: none"> <select v-model="m.sub_medida"
                                                                    class="form-control" v-if="m.tipo==1">
                                                            ...
                                                            <td style="display: none"> <select v-model="m.producto_model.pigmento"
                                                                    class="form-control">
                                                                    <option value="1">SI</option>
                                                                    <option value="2">NO</option>
                                                                </select>
                                                            </td>
                                                            <td style="display: none"> <select v-model="m.tipo"
                                                                    class="form-control">
                                                                    <option value="1">POLLO</option>
                                                                    <option value="0">PRESA</option>
                                                                </select>
                                                    ...
                                                    <tfoot>
                                                        <tr class="table-default">
                                                            <td colspan="4">Cantidad de Aves</td>
                ...
                methods: {
                    ...
                    async Save() {
                        ...
                        try {
                            ...
                            let res = await axios.post("{{ url('api/compras-aves') }}", this.model);
                            const swalWithBootstrapButtons = swal.mixin({
                                confirmButtonClass: 'btn btn-success btn-rounded',
                                cancelButtonClass: 'btn btn-danger btn-rounded mr-3',
                                buttonsStyling: false,
                        ...
                        try {
                            ...
                            await Promise.all([self.GET_DATA('categorias'), self.GET_DATA('medidas'), self
                                .GET_DATA('productos'), self.GET_DATA('almacens'), self.GET_DATA(
                                    'proveedorComprasAves'), self.GET_DATA('cajaInventarios')
                            ]).then((v) => {
                                self.categorias = v[0]
                                self.medidas = v[1]
                                self.productos = v[2]
