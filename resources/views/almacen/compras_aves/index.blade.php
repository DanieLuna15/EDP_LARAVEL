...
<div id="block_ui">
    <div class="action-btn layout-top-spacing mb-5">
        <div class="page-header">
            ...
            <div>
                <a href="./compras-aves/add" class="btn btn-success">Nueva Compra Lote de Aves</a>
                <a href="./compras-aves/compras-cerradas" class="btn btn-danger">Compras Cerradas</a>
            </div>
        </div>
            ...
            methods: {
                ...
                async load() {
                    try {
                        let self = this
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/compras-aves-vigentes')}}")]).then((v) => {
                                self.data = v[0]
                            })
