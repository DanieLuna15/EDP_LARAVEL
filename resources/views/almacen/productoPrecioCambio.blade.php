        ...
        <div class="page-header">
            <div class="page-title">
                <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid">
                    ...
                    </svg> Cambio de precios por producto</p>
            </div>
                ...
                <tr v-for="(m,i) in data">
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <a href="javascript:void(0)" data-toggle="modal" data-target="#exampleModal" @click="model.url=m.url_pdf"class="dropdown-item">Enviar WhatsApp</a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalCrud">ENVIAR A WHATSAPP</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-row mb-4">
                            <div class="form-group col-md-12">
                                <label for="inputEmail4">Telefono (+{{codigo}})</label>
                                <input type="text" v-model="model.telfono" class="form-control" placeholder="987987">
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button @click="EnviarWhatsapp()" type="button" data-dismiss="modal" class="btn btn-primary">Enviar</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            methods: {
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/productoPrecioCambiosFecha')}}")]).then((v) => {
                                self.data = v[0]
                            })
                ...
                async ConsultarFecha(){
                    ...
                    try {
                        ...
                        dt.destroy()
                        let res = await axios.post("{{url('api/productoPrecioCambiosFecha')}}",data).then((v) => {
                                self.data = v.data
                            })
                ...
                EnviarWhatsapp(){
                    window.open('https://api.whatsapp.com/send?phone='+this.codigo+this.model.telfono+'&text=Hola%20le%20envio%20su%20comprobante%20de%20cambio%20de%20precios%20con%20link%20'+this.model.url,'_blank');
                }
            },
            mounted() {
                this.$nextTick(async () => {
