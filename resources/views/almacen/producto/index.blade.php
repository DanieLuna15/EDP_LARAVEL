                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                </svg> Almacen / Producto</p>
                        </div>
                        <a href="./productos/add" class="btn btn-success">Agregar</a>
                    </div>
                                ...
                                <table id="table_dt" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr v-for="(m,i) in data">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a :href="'./productos/edit/' + m.id" class="btn btn-warning btn-sm">Editar</a>
                                                    <button type="button"
                ...
                methods: {
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/productos') }}")]).then((v) => {
                                    self.data = v[0]
                                })
