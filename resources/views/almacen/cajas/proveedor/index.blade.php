                ...
                methods: {
                    async Save() {
                        try {
                            ...
                            let url = "{{ url('api/cajaProveedors') }}";
                            if (this.add == false) {
                                url = "{{ url('api/cajaProveedors') }}/" + this.model.id
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/cajaProveedors') }}")]).then((v) => {
                                    self.data = v[0]
                                })
                        ...
                        swalWithBootstrapButtons({
                            ...
                            if (result.value) {
                                try {
                                    ...
                                    let url = "{{ url('api/cajaProveedors') }}/" + id
