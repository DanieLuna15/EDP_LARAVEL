                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                </svg> Almacen / Compras de cajas</p>
                        </div>
                        <a href="./compras/add" class="btn btn-success">Agregar</a>
                    </div>
                                ...
                                <table id="table_dt" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr v-for="(m,i) in data">
                                            ...
                                            <td>{{ m . total }}</td>
                                            <td>{{ m . monto }}</td>
                                            <td>{{ Number(m . total - m . monto) . toFixed(2) }}</td>

                                            <td>
                                                <span v-if="m.tipo==1" class="badge bg-success">Contado</span>
                                                <span v-else class="badge bg-warning">Credito</span>
                                            </td>
                ...
                methods: {
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/compraCajas') }}")]).then((v) => {
                                    self.data = v[0]
                                })
