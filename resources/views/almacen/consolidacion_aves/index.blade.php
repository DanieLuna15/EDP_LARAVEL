...
<div id="block_ui">
    <div class="action-btn layout-top-spacing mb-5">
        <div class="page-header">
            ...
            <a href="./add-ave" class="btn btn-success">Agregar Consolidacion</a>
        </div>
            ...
            <table id="table_dt" class="table table-hover non-hover" style="width:100%">
              <thead>
                <tr>
                  ...
                  <th>#</th>
                  <th>Fecha</th>
                  <th>Nro Compra Aves</th>
                  <th>Nro de lote Aves</th>
              ...
              <tbody>
                <tr v-for="(m,i) in data">
                  ...
                  <td>{{m.valor_total}}</td>
                  <td>
                      <span v-if="m.consolidacion_pago_detalle!=null" class="badge bg-primary">Con pago</span>
                    ...
                    <div class="btn-group">
                      ...
                      <button type="button" class="btn btn-success btn-sm dropdown-toggle dropdown-toggle-split" :id="'menu'+i" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-reference="parent">
                        ...
                        <div class="dropdown-menu" :aria-labelledby="'menu'+i">
                          <a :href="m.url_cambios_pdf" class="dropdown-item" target="_blank">Cambio de Precio PDF</a>
                        <a :href="'./edit-ave/'+m.id" class="dropdown-item">Asignar/Editar Precio</a>
                          <a :href="m.detalle_pagos_url_pdf" class="dropdown-item" target="_blank">Detalle Pago PDF</a>
            ...
            methods: {
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/consolidacions_aves')}}")]).then((v) => {
                                self.data = v[0]
                            })
                    ...
                    swalWithBootstrapButtons({
                        ...
                        if (result.value) {
                            try {
                                ...
                                let url = "{{url('api/consolidacions_aves')}}/"+id
