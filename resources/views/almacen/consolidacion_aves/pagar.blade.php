            ...
            <div id="block_ui">
                <div class="action-btn layout-top-spacing mb-5">
                    <div class="page-header">
                        ...
                        <a href="./pagar-ave/add" class="btn btn-success">Pagar Compras de Aves</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                ...
                methods: {
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/consolidacionAvePagos') }}")]).then((
                                    v) => {
                                    self.data = v[0]
                                })
                        ...
                        swalWithBootstrapButtons({
                            ...
                            if (result.value) {
                                try {
                                    ...
                                    let url = "{{ url('api/consolidacionAvePagos') }}/" + id
