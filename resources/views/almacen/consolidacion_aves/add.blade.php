                                            ...
                                            <div v-else class="row">
                                                                            ...
                                                                            <table id="table_dt"
                                                                                ...
                                                                                <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th class="text-success" style="display: none">CBBA</th>
                                                                                        <th class="text-success" style="display: none">LP</th>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="row bg-dark p-2">
                                                        ...
                                                        <div class="col-sm-2 col-12 m-4" >
                                                            <div class="form-group">
                                                                <label for="fullName" class="text-success fw-bold">Total de Aves</label>
                ...
                methods: {
                    ...
                    async Save() {
                        ...
                        try {
                            ...
                            let res = await axios.post("{{ url('api/consolidacions_aves') }}", this.model)
