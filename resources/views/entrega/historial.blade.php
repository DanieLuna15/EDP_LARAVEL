...
@verbatim
    <div id="block_ui">
        ...
        <div class="row">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-3 pt-2">
                                    <button class="btn btn-success mt-4" @click="ConsultarFecha()" :disabled="loading.consultar">
                        ...
                        <table id="table_dt" class="table table-hover non-hover" style="width:100%">
                            ...
                            <tbody>
                                <tr v-for="(m,i) in ventas">
                                    <td>{{m . id}}</td>
                                    <td>{{m . fecha}} {{m . hora}}
                                        <span v-if="m.entregado==1" class="badge badge-danger"><i class="fa fa-times"></i></span>
                                    ...
                                    <td>
                                        ...
                                        <span v-else-if="m.metodo_pago == 2" class="badge badge-info">CREDITO</span>
                                ...
                                <td>
                                        <span v-if="(m.metodo_pago == 2 || m.metodo_pago == 3) && m.pagado_total == 0" class="badge badge-danger">NO INICIADO AUN</span>
                                        <span v-else-if="m.metodo_pago == 1 && m.pendiente_total == 0" class="badge badge-success">PAGADO</span>
                                        <span v-else-if="(m.metodo_pago == 2 || m.metodo_pago == 3) && m.pendiente_total == 0" class="badge badge-success">PAGADO</span>
                                        <span v-else-if="(m.metodo_pago == 2 || m.metodo_pago == 3) && m.pendiente_total > 0 && m.pagado_total > 0" class="badge badge-warning">PENDIENTE</span>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" :aria-labelledby="'menu'+i">
                                                ...
                                                <a v-if="!(
                                                        (m.metodo_pago == 1 && m.pendiente_total == 0) ||
                                                        ((m.metodo_pago == 2 || m.metodo_pago == 3) && m.pendiente_total == 0)
                                                    )"
                                                    href="javascript:void(0)"
                                                    class="dropdown-item"
                                                    data-toggle="modal"
                                                    data-target="#modalDesapacho"
                                                    @click="SelectVenta(m)">
                                                    DESPACHAR/COBRAR
                                                </a>

                                                <a  class="dropdown-item" href="javascript:void(0)" @click="abrirModalVentasCredito(m.cliente)">COBRO GLOBAL</a>
                                                <a style="display: none" class="dropdown-item" href="javascript:void(0)" @click="deleteItem(m.id)">Eliminar</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="" class="form-control" id="" :value="venta.total" disabled>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="">Total Pagado</label>
                                        <input type="text" name="" class="form-control" id="" :value="venta.pagado_total" disabled>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="">Total Pendiente</label>
                                        <input type="text" name="" class="form-control" id="" :value="venta.pendiente_total" disabled>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="">Cajas Venta</label>
                                        <input type="text" name="" class="form-control" id="" :value="venta.cajas_venta" disabled>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="">Cajas Pendientes</label>
                                        <input type="text" name="" class="form-control" id="" :value="venta.cantidad_cajas" disabled>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="">Cajas / Recibir</label>
                                        <input type="text" name="" class="form-control" id="" v-model="despacho.cajas_entregar" >
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="">Tipo de venta</label>
                                        <select name="" class="form-control" disabled v-model="venta.metodo_pago" id="">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select name="" class="form-control" id="" v-model="despacho.formapago_id">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" data-dismiss="modal" class="btn btn-success" @click="Save()" :disabled="loading.save">
            ...
            <div class="modal fade" id="modalVentasCredito" tabindex="-1" role="dialog" aria-labelledby="modalCrud" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col-12">
                                     <div v-if="showCreditoError" class="alert alert-success">
                                        <div>
                                            <strong>El cliente no tiene ventas(despachadas) a crédito con saldo pendiente de pago.</strong>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer">
                            <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Cancelar</button>
                            <button type="button" class="btn btn-success" @click="confirmarPago" :disabled="loading.cobrar || showCreditoError">
...
@endverbatim
<div class="modal fade" id="modalBloqueoCaja" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content border border-info">
            <div class="modal-header bg-info">
                <h5 class="modal-title w-100 text-white text-center m-0"><strong>No tienes una caja activa abierta.</strong></h5>
            </div>
            <div class="modal-body text-center">
                <img src="{{ asset('/img/pos_caja.png') }}" alt="Caja no encontrada" class="img-fluid mb-3" style="max-height: 150px;">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-success" data-dismiss="modal" @click="AbrirCajaDesdeVista" :disabled="!model.caja_sucursal_usuario_id">
          Guardar
        </button>
      </div>
    </div>
        ...
        methods: {
            ...
            async confirmarPago() {
                ...
                if (this.totalPagarEditable  <= 0 || this.ventasSeleccionadas.length === 0) {
                    return swal.fire('Error', 'El monto de pago debe ser mayor que cero, al menos debe seleccionar una venta', 'error');
                }
                if (!this.formapagoGlobal) {
                    return swal.fire('Error', 'Debes seleccionar una forma de pago para continuar', 'error');
                }
            ...
            async checkCajaActiva() {
                try {
                    let res = await axios.get("{{url('api/caja-activa-usuario')}}/" + this.user.id + '/' + this.sucursal.id)
            ...
            async Save() {
                ...
                try {
                    ...
                    onOpen: (el) => {
                        el.querySelector('#btn-cerrar')?.addEventListener('click', (e) => {
                            e.preventDefault();
                            e.stopPropagation();
                             swal.close();
                            // Mostrar un swal de confirmación
            ...
            async load() {
                try {
                    ...
                    try {
                        await Promise.all([
                            self.GET_DATA("{{url('api/caja-activa-usuario')}}/" + self.user.id + '/' + self.sucursal.id),
                            self.GET_DATA("{{ url('api/cajas-usuario') }}/" + self.user.id + '-' + self.sucursal.id),
