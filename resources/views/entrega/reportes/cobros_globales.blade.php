                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                </svg> Entregas / Reportes Cobranzas / Cobros Globales</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-3 pt-4">
                                <button class="btn btn-success mt-2" @click="consultarCobrosGlobales()">Consultar</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <h5>Cobros Globales</h5>
                                    <table id="table_dt_cuentas" class="table table-hover non-hover" style="width:100%">
                                        ...
                                        <tbody>
                                            <template v-for="(cobro, index) in cobrosGlobales" :key="index">
                                                <tr>
                                                    <td>{{ cobro.id }}</td>
                                                    <td>[#{{ cobro.id_venta.join(', #') }}]</td>
                    ...
                    async consultarCobrosGlobales() {
                        ...
                        try {
                            ...
                            const res = await axios.post(
                                "{{ url('api/cobros/filtrar-cobros-globales') }}", {
                                    fecha_inicio: this.fecha_inicio,
                                    fecha_fin: this.fecha_fin,
                                    cliente_id: this.cliente_id
                                });
                                this.cobrosGlobales = res.data.cobrosGlobales ? Object.values(res.data.cobrosGlobales) : [];
                                dt.destroy();
                                await this.$nextTick(() => {
                                    dt.create({
                                        order: [
                            ...
                            if (this.cobrosGlobales.length > 0) {
