                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                </svg> Entregas / Reportes Cobranzas / Histórico de Cuentas por cobrar</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    async consultarCuentasxCobrar() {
                        ...
                        try {
                            ...
                            const res = await axios.post(
                                "{{ url('api/cuentasPorCobrar/filtrar-cuentas-por-cobrar-historico') }}", {
                        ...
                        [];
                            ...
                            if (this.ventasCredito.length > 0) {
                                ...
                                swal.fire('Información',
                                    'No se encontraron resultados el o los clientes seleccionado.', 'info');
                            }
                        } catch (e) {
