            ...
            <table id="table_dt" class="table table-hover non-hover" style="width:100%">
              ...
              <tbody>
                <tr v-for="(m,i) in data">
                  ...
                  <td>{{m.pp_detalle.lote_detalle.name}}</td>
                  <td>{{m.pp_detalle.lote_detalle.equivalente}}</td>
                  <td>{{m.pp_detalle.cantidad}}</td>
                  <td>{{m.pt_detalle.cantidad}}</td>
            ...
            methods: {
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/loteEnvioPppts')}}")]).then((v) => {
                                self.data = v[0]
                            })
