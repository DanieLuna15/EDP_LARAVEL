                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" :aria-labelledby="'menu' + i">
                                                        ...
                                                        <a :href="'./image/externa/' + m.id" class="dropdown-item">Imagen</a>
                ...
                methods: {
                    async Save() {
                        try {
                            ...
                            let url = "{{ url('api/compoExternas') }}";
                            if (this.add == false) {
                                url = "{{ url('api/compoExternas') }}/" + this.model.id
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/compoExternas') }}")]).then((v) => {
                                    self.data = v[0]
                                })
