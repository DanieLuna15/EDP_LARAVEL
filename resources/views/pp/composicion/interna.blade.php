                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" :aria-labelledby="'menu' + i">
                                                        <a :href="'./image/interna/' + m.id" class="dropdown-item">Imagen</a>
                ...
                methods: {
                    async Save() {
                        try {
                            ...
                            let url = "{{ url('api/compoInternas') }}";
                            if (this.add == false) {
                                url = "{{ url('api/compoInternas') }}/" + this.model.id
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/compoInternas') }}")]).then((v) => {
                                    self.data = v[0]
                                })
                        ...
                        swalWithBootstrapButtons({
                            ...
                            if (result.value) {
                                try {
                                    ...
                                    let url = "{{ url('api/compoInternas') }}/" + id
