                ...
                <div class="action-btn layout-top-spacing mb-5">
                    <div class="page-header">
                        ...
                        <button data-toggle="modal" data-target="#exampleModal" @click="add=true,model.name=''"
                            class="btn btn-success" :disabled="pps.length >= 2"  :title="pps.length >= 2 ? 'No se puede abrir más lotes, por favor cierra los anteriores lotes' : ''">INICIAR PP</button>
                    </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalCrud">INICIAR PP</h5>
                                ...
                                <div class="modal-body">
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail4">NRO DE PP</label>
                    ...
                    <div v-for="m in pps" class="col-lg-4 col-md-12 col-12 mb-2">
                        <div class="widget widget-card-four">
                            <div class="widget-content">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <a :href="'./detalle/' + m.id" class="btn btn-success w-100">VER DETALLE</a>
                                    </div>
                                    <div class="col-12 mt-2">
                                        <div class="btn-group w-100">
                                            <a :href="m.url_pdf" target="_blank" class="btn btn-primary"> PDF PESO 1</a>
                                            <a :href="m.url_inicial_2_pdf" target="_blank" class="btn btn-primary">PDF PESO 2</a>
                                            <a :href="m.url_inicial_total_pdf" target="_blank" class="btn btn-info ">PDF TOTAL</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" :aria-labelledby="'menu' + i">
                                                        ...
                                                        <a :href="m.url_general_pdf" target="_blank" class="dropdown-item">DETALLE
                                                            GENERAL</a>
                                                        <a :href="m.url_entrada_pdf" target="_blank" class="dropdown-item">
                                                            ENTRADA DE LOTES</a>
                                                        <a :href="m.url_venta_pdf" target="_blank" class="dropdown-item"> VENTAS
                                                            DE PP</a>
                                                        <a :href="m.url_aceptado_pdf" target="_blank" class="dropdown-item">
                                                            LOTES ACEPTADOS DE PP</a>
                                                        <a :href="m.url_envio_pdf" target="_blank" class="dropdown-item"> ENVIOS
                                                            DE PP</a>
                                                        <a :href="m.url_pdf" target="_blank" class="dropdown-item"> PP PESO
                                                            INICIAL 1</a>
                                                        <a :href="m.url_inicial_2_pdf" target="_blank" class="dropdown-item"> PP
                                                            PESO INICIAL 2</a>
                                                        <a :href="m.url_inicial_total_pdf" target="_blank" class="dropdown-item">
                                                            PP PESO TOTAL 1 Y 2</a>
                ...
                methods: {
                    async Save() {
                        if (this.model.nro.trim() == '') {
                            swal('Error', 'El nro de PP es obligatorio', 'error')
                            return
                        }
                        try {
                            block.block()
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/pps/curso/') }}/" + this.sucursal.id),
                                    self.GET_DATA("{{ url('api/pps') }}")
                                ]).then((v) => {
                                    self.pps = v[0]
                                    self.data = v[1]
                                })
