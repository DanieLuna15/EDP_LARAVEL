    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 my-2 text-center" v-if="model.curso==1">
                            <a class="btn btn-warning"   :href="'../cerrar-pp/'+model.id">FINALIZAR PP</a>
                        ...
                        <div class="col-12 text-center">
                                <button class="btn btn-warning" v-if="lotes_desconpuestos.length>0"  @click="DescomponerTodo()">DESCOMPOSICIÓN GENERAL</button>
                            </div>
        ...
        <div class="col-sm-12 col-12">
            <div class="row">
                ...
                <div class="col-lg-6 col-12 layout-spacing" v-for="m in model.pp_traspaso_pps">
                    <div class="statbox widget box box-shadow">
                        <div class="widget-content widget-content-area border-tab px-2">
                            <div class="d-flex justify-content-between">
...
<script type="module">
    ...
    createApp({
        ...
        methods: {
            //agregqr usuario y fecha y hora
            ...
            async load() {
                try {
                    ...
                    try {
                        await Promise.all([self.GET_DATA("{{url('api/pps')}}/{{$id}}"),
