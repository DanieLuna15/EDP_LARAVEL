        ...
        @verbatim
            <div v-if="!loading" class="osahan-body" id="app">
                ...
                <div class="p-3 osahan-categories">
                    <h6 class="mb-2">AGREGAR CLIENTE</h6>
                    <div class="bg-white shadow-sm rounded widget-content-area br-6 p-3">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-6">
                                ...
                                <div class="form-group ">
                                    <label>Tipo cliente Caja C. </label>
                            ...
                            <div class="col-sm-3 col-6">
                                <div class="form-group ">
                                    <label>Tipo cliente Trans. </label>
                            ...
                            <div class="col-sm-3 col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="true" :disabled="!model.is_iva" v-model="model.iva"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-3">
                                        <div id="iconsAccordion2" class="accordion-icons">
                                            <div class="card">
                                                <div class="card-header bg-info text-white" id="headingOne2">
                                                    <section class="mb-0 mt-0">
                                                        <div role="menu" class="" data-toggle="collapse"
                                    ...
                                    <div class="col-12 mt-3">
                                        <div id="iconsAccordion3" class="accordion-icons">
                                            <div class="card">
                                                <div class="card-header bg-info text-white" id="headingOne3">
                                                    <section class="mb-0 mt-0">
                                                        <div role="menu" class="" data-toggle="collapse"
                ...
                methods: {
                    ...
                    async Save() {
                        ...
                        try {
                            ...
                            this.model.preventista_id = this.user.id
