@component('preventista.template.master', ['title' => 'Preventista'])
    @slot('body')
        @verbatim
            <div v-if="!loading" class="osahan-body" id="meApp">
                <!-- categories -->
                                        ...
                                        <div class="card-header" id="headingOne">
                                            <section class="mb-0 mt-0">
                                                <div role="menu" class="" data-toggle="collapse"
                                                    ...
                                                    <div class="accordion-icon d-flex align-items-center justify-content-center">
                                                        ...
                                                        <span class="badge bg-danger text-white ml-2">CAJAS CERRADAS</span>
                                                    </div>
                                                </div>
                                            </section>
                                        </div>
                                        <div id="iconAccordionOne" class="collapse show" aria-labelledby="headingOne"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" v-model="precio_producto">
                                                    ...
                                                    <div class="col-sm-6 col-12">
                                                        <div class="form-group">
                                                            <label for="fullName">Valor</label><input type="text" v-model="valor"
                                                                ...
                                                                <tr v-for="(m,i) in caja_cerradas_model">
                                                                    ...
                                                                    <td>
                                                                        <button class="btn btn-danger btn-sm"
                                                                            @click="m.estado=0">Eliminar</button>
                                                                    </td>

                                                                </tr>
                                                                <tr v-for="(m,i) in cajas_cerradas">
                                                                    <td>{{ i + 1 }}</td>
                                                                    <td>{{ m . precio_producto . name }}
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" class="form-control form-control-sm"
                                                                            v-model="m.valor" />
                                            ...
                                            <section class="mb-0 mt-0">
                                                <div role="menu" class="" data-toggle="collapse"
                                                    ...
                                                    <div class="accordion-icon d-flex align-items-center justify-content-center">
                                                        ...
                                                        <span class="badge bg-danger text-white ml-2">PP</span>
                                                    </div>
                                                </div>
                                            </section>
                                        </div>
                                        <div id="iconAccordionOne2" class="collapse show" aria-labelledby="headingOne2"
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 col-12">
                                                        <div class="form-group">
                                                            <label for="fullName">Valor</label><input type="text"
                                                                v-model="valor" class="form-control mb-4" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                            ...
                                            <section class="mb-0 mt-0">
                                                <div role="menu" class="" data-toggle="collapse"
                                                    ...
                                                    <div class="accordion-icon d-flex align-items-center justify-content-center">
                                                        ...
                                                        <span class="badge bg-danger text-white ml-2">PT</span>
                                                    </div>
                                                </div>
                                            </section>
                                        </div>
                                        <div id="iconAccordionOne3" class="collapse show" aria-labelledby="headingOne3"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" v-model="item">
                                                                <template v-for="m in items">
                                                                    <option v-if="m.tipo == 2 || m.tipo == 3" :value="m">
                                                                        {{ m . name }}</option>
                                                                </template>
                                                            </select>
                                                        </div>
                    ...
                    this.$nextTick(async () => {
                        ...
                        try {
                            ...
                            await Promise.all([self.GET_DATA('documentos'), self.GET_DATA(
                                    "clientes/{{ $id }}"), self.GET_DATA('tipoclientes'),
