...
<div v-if="!loading" class="osahan-body" id="app">
    ...
    <div class="p-3 osahan-categories">
        ...
        <div class="row m-0 p-0">
                    ...
                    <table class="table table-bordered">
                        <thead class="bg-info text-white">
                            <tr>
                                ...
                                <th colspan="17" class="text-left text-white">DETALLE VENTA</th>

                            </tr>
                            <tr >

                                <th class="text-left text-white">TIPO</th>
                                <th class="text-left text-white">LOTE</th>
                                <th class="text-left text-white">N COMPRA</th>
                                <th class="text-left text-white">CINTA</th>
                                <th class="text-left text-white">PIGMENTO</th>
                                <th class="text-left text-white">CAJAS</th>
                                <th class="text-left text-white">POLLOS</th>
                                <th class="text-left text-white">PESO BRUTO</th>
                                <th class="text-left text-white">TARA</th>
                                <th class="text-left text-white">PESO NETO</th>
                                <th class="text-left text-white">P. NETO U.</th>
                                <th class="text-left text-white">P. BRUTO U.</th>
                                <th class="text-left text-white">
                                    DESC/REC
                                </th>
                                <th class="text-left text-white">Desc/Rec Total </th>
                                <th class="text-left text-white">Precio Kg </th>
                                <th class="text-left text-white">Total Bs/ </th>
                                <th class="text-left text-white">Accion</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr v-for="(item,i) in CartTransformacions" class="tr-hover">
                                ...
                                <td>***</td>
                                <td> <input type="text" class="form-control" readonly :value="item.total_cajas" @change="changeCajasItem(item)"> </td>
                                <td>***</td>
                                <td> <input type="text" class="form-control" readonly :value="item.total_peso_bruto" @change="changePesoBrutoItem(item)"> </td>
                                <td> <input type="text" class="form-control" readonly :value="item.total_peso_bruto-item.total_peso_neto"> </td>
                                <td> <input type="text" class="form-control" readonly :value="item.total_peso_neto" @change="changePesoNetoItem(item)"> </td>
                                <td>***</td>
                                <td>***</td>
                                <td>***</td>
                                ...
                                <td>{{Number(item.total_final).toFixed(2)}}</td>
                                <td>
                                    <button class="btn btn-danger p-1" @click="transformacion_cart.splice(i,1)">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2">
                                            <polyline points="3 6 5 6 21 6"></polyline>
                                            <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
                                            <line x1="10" y1="11" x2="10" y2="17"></line>
            ...
            <div class="col-lg-12 col-12 mt-2 p-0">
                <div class="row">
                        ...
                        <div class="info">
                            <div class="row">
                                <div class="col-12 text-center">
                                    <label><strong>BUSCAR ITEMS PARA VENDER</strong></label>
                                </div>
                                <div class="col-12 ">
                                    <div class="row">
                                        <div class="col-12">
                                                ...
                                                <div class="input-group">
                                                    <select v-model="caja_cerrada_id" class="form-control select_cajas_cerradas">
                                                        <template v-for="m in cajas_cerrada">
                                                            ...
                                                            <option v-if="m.lote_detalle.cajas>0" :value="m.id">{{m.compra.proveedor_compra.abreviatura}}-{{m.compra.nro_compra}}*{{m.compra.proveedor_compra.abreviatura}}-{{m.compra.nro}}*{{m.cinta}}</option>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <table class="table table-bordered">
                                                            <thead class="bg-info text-white">
                                                                <th class="text-left text-white">Nro Compra</th>
                                                                <th class="text-left text-white">Lote</th>
                                                                <template v-for="m in listaCintasCajaCerrada">
                                                                    <th class="text-left text-white">{{m}}</th>
                                                                </template>
                                                                        ...
                                                                        <template v-for="c in m.filtro_cintas_cajas">
                                                                            <td>
                                                                                <div class="d-flex">
                                                                                    ...
                                                                                    <button v-if="c.lote_detalle.cajas>0" :disabled="cliente.id==''" class="btn btn-success p-1" @click="AddDetalle(c.lote_detalle,c.compra,c.cinta,c.dias)">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="col-12 " v-if="pp.hasOwnProperty('pp')">
                                                    <table class="table table-bordered">
                                                        <thead class="bg-info text-white">
                                                            <tr>
                                                                <th class="text-left text-white">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <template v-for="m in transformacions">
                                                                <tr class="tr-hover" v-for="item in m.lista_subitems_transformacion" @click="AddTransformacion(item,m)">
                                                                    <td>#-{{m.nro}}</td>
                                                                    <td>{{item.subitem.name}}</td>
                                    ...
                                    <div class="row">
                                            ...
                                            <table class="table table-bordered">
                                                        <thead class="bg-info text-white">
                                                            <tr>
                                                                ...
                                                                <th colspan="13" class="text-left text-white">CAJAS CERRADAS</th>
                                                            ...
                                                            <tr v-for="(l,i) in DetalleVentaLotes">
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <button class="btn btn-success p-1" @click="addVentaLoteCarrito(l,i)">
                                                ...
                                                <table class="table table-bordered">
                                                    <thead class="bg-info text-white">
                                                        <tr>
                                                            ...
                                                            <th colspan="13" class="text-left text-white">TRANSFORMACIONES</th>

                                                        </tr>
                                                        <tr>

                                                            <th class="text-left text-white">N°</th>

                                                            <th class="text-left text-white">PRODUCTO </th>
                                                            <th class="text-left text-white">CAJAS </th>
                                                            <th class="text-left text-white">PESO </th>
                                                            <th class="text-left text-white">PRECIO </th>
                                                    ...
                                                    <tbody>
                                                        <template v-for="(m,i) in TransformacionDetalles">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control form-control-sm" v-model="m.total_cajas">
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control form-control-sm" v-model="m.total_peso_bruto">
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control form-control-sm" v-model="m.subitem.venta">
                                                                </td>
                                                                <td>
                                                                    <div class="btn-group">
                                                                        <button class="btn btn-danger p-1" @click="transformacions_list.splice(i,1)">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2">
                                                                                <polyline points="3 6 5 6 21 6"></polyline>
                                                                                <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
                                                                                <line x1="10" y1="11" x2="10" y2="17"></line>
                                                                        ...
                                                                        <button class="btn btn-success p-1" @click="addTransformacionCarrito(m,i)">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                                                                <polyline points="20 6 9 17 4 12"></polyline>
                                                                            </svg>
                                                                        </button>
                                        ...
                                        <div class="col-12 mt-2 " v-if="PpItemsModel.length">
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <thead class="bg-info text-white">
                                                        <tr>
                                                            <th colspan="10" class="text-left text-white">
                                                                ITEMS PP
                                                            </th>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-left text-white">PP</th>
                                                            <th class="text-left text-white">Pollos</th>
                                                            <th class="text-left text-white">Cajas</th>
                                                            <th class="text-left text-white">P.Bruto</th>
                                                            <th class="text-left text-white">Taras</th>
                                                            <th class="text-left text-white">P. Neto</th>
                                                            <th class="text-left text-white">P. Neto U</th>
                                                            <th class="text-left text-white">Precio KG</th>
                                                            <th class="text-left text-white">Total Bs/.</th>
                                                        ...
                                                        <tr v-for="(l,i) in PpItemsModel">
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <button class="btn btn-success p-1" @click="addVentaPpCarrito(l,i)">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                                                            <polyline points="20 6 9 17 4 12"></polyline>
                                                                        </svg>
                                                                    </button>
                                        ...
                                        <div class="col-12 mt-2 " v-if="venta_items.length">
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    <thead class="bg-info text-white">
                                                        <tr>
                                                            <th colspan="8" class="text-left bg-info text-white">
                                                                ITEMS PT
                                                            </th>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr v-for="(item,i) in venta_items" class="tr-hover">
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <button class="btn btn-success p-1" @click="addVentaPtCarrito(item,i)">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                                                            <polyline points="20 6 9 17 4 12"></polyline>
                                                                        </svg>
                                                                    </button>
                                                        ...
                                                        <template v-for="(item,i) in gastos">
                                                            <tr class="tr-hover">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button class="btn btn-success p-1" @click="AddGasto(item,i)">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check">
                                                                            <polyline points="20 6 9 17 4 12"></polyline>
                                                                        </svg>
                                                                    </button>
                                        ...
                                        <div class="col-12 text-center  mt-2">
                                            <button @click="Vender" class="btn btn-success btn-block w-100 p-4">
                                                <h4 class="text-white">FINALIZAR PREVENTA</h4>
                                            </button>
   ...
   model_cintas1(){
    ...
    methods: {
        ...
        addVentaLoteCarrito(d,i){
            ...
            let descuento_filter = this.ClienteCajacerradas.filter((b)=>b.producto_precio.name==d.producto)
            let item = {...d}
                item.descuento_valor = 0
            if(descuento_filter.length>0){
                item.descuento_valor = descuento_filter[0].valor
            }
            let descuento = {...this.getDescuentoProductoPrecio(producto)}
