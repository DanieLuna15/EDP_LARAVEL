...
<body class="white-bg">
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                ...
                <?php
                    ...
                    $tara = 0;
                    $peso_neto = 0;
                    foreach ($pt->DetallePts()->where('peso_inicial_tipo',1)->get() as $de) {
                        $cajas += $de->cajas;
                        $pollos += $de->pollos;
    ...
    {{-- <div class="tabla_borde">
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                <tr>
                    <th align="center" colspan="5" class="bold section-title"><strong>TRANSFORMACIONES</strong>
                    </th>
                </tr>
                <tr class="border_top">
