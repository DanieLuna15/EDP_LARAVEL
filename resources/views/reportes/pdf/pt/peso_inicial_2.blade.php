...
<body class="white-bg">
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                ...
                <?php
                        ...
                        $tara = 0;
                        $peso_neto = 0;
                        foreach ($pt->DetallePts()->where('peso_inicial_tipo',2)->get() as $de) {
                            $cajas += $de->cajas;
                            $pollos += $de->pollos;
                ...
                <?php
                    ...
                    ?>
                <tr class="border_top">
                    <th align="left" class="bold" colspan="5">TOTALES</th>
    ...
    {{-- <div class="tabla_borde">
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                <tr>
                    <th align="center" colspan="5" class="bold section-title"><strong>TRANSFORMACIONES</strong></th>
                </tr>
                <tr class="border_top">
            ...
            ?>
                <tr class="border_top">
                    <th align="left" class="bold section-title" colspan="5">
                ...
                ?>
                <tr class="border_top">
                    <th align="left" class="bold"><strong>TOTAL SALDO DE {{ $de['item']['name'] }}</strong></th>
