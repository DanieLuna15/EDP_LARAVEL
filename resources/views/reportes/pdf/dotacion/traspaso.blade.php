                        ...
                        <tbody>
                            <tr>
                                <td width="50%" height="0" align="center">
                                    @if (!empty($traspaso->sucursal->image) && !empty($traspaso->sucursal->image->path_url))
                                        <img src="{{ $traspaso->sucursal->image->path_url }}" class="img-fluid"
                                    ...
                                    <div class="tabla_borde">
                                        <table width="100%" border="0" height="50" cellpadding="6"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="center">
                                                        <span
                                                            ...
                                                            text-align="center">T R A S P A S O &nbsp; D E &nbsp; D O T
                                                            A C I O N</span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <span style="font-size:24px">N° <?= $traspaso->id ?> </span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="center" colspan="2">
                                                        <strong><span
                                                                style="font-size:15px"><?= $traspaso->sucursal->nombre ?></span></strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left">
                                                        <strong><?= $traspaso->sucursal->documento->name ?>:
                                                        </strong><?= $traspaso->sucursal->doc ?>
                                                    </td>
                                                    <td align="left">
                                                        <strong>Email: </strong><?= $traspaso->sucursal->email ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left">
                                                        <strong>Dirección:
                                                        </strong><?= $traspaso->sucursal->direccion ?>
                                                    </td>
                                                    <td align="left">
                                                        <strong>Telefono: </strong><?= $traspaso->sucursal->telefono ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left">
                                                        <strong>Responsable:
                                                        </strong><?= $traspaso->sucursal->responsable ?>
                                                    </td>
                                                    <td align="left">
                                                        <strong>Medidor: </strong><?= $traspaso->sucursal->medidor ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left">
                                                        <strong>Sucursal Destino:
                                                        </strong><?= $traspaso->SucursalDestino->nombre ?>
                                                    </td>
                                                    <td align="left">
                                                        <strong>Direccion:
                                                        </strong><?= $traspaso->SucursalDestino->direccion ?>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td align="left"><strong>Nombre:</strong>
                                                                        <?= $traspaso->user->nombre ?>
                                                                        <?= $traspaso->user->apellidos ?></td>
                                                                    <td align="left"><strong>Correo:</strong>
                                                                        <?= $traspaso->user->correo ?></td>

                                                                    <td align="left">
                                                                        <strong>Usuario: </strong>
                                                                        <?= $traspaso->user->usuario ?>
                    ...
                    <div class="tabla_borde">
                        <table width="100%" border="0" cellpadding="5" cellspacing="0">
                            <tbody>
                                ...
                                <?php
                                        foreach($traspaso->detalles as $s){
                                       ?>
                                <tr class="border_top">
                                    <td align="left">
