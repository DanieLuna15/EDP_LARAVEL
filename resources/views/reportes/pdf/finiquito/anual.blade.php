                                ...
                                <tr>
                                    <td align="center">
                                        <span style="font-family:Tahoma, Geneva, sans-serif; font-size:19px"
                                            text-align="center">F I N I Q U I T O &nbsp; A N U A L</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">
                                            ...
                                            <table width="100%" border="0" height="50" cellpadding="6"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            @if (!empty($finiquito->sucursal->image) && !empty($finiquito->sucursal->image->path_url))
                                                            ...
                                                            <table width="200px" height="0" border="0"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="40%" align="left"><strong>Fecha
                                                                                Emision: </strong>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <span
                                                                style="font-family:Tahoma, Geneva, sans-serif; font-size:14px; font-weight: bold;"
                                                                text-align="center">DATOS DEL CONTRATADO</span>
                                                        </td>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td align="left"><strong>Fecha Inicio:
                                                                            ...
                                                                            <?= $finiquito->contrato->inicio ?></td>
                                                                        <td align="left"><strong>Fecha Fin: </strong>
                                                                            <?= $finiquito->contrato->fin ?></td>
                                                                    ...
                                                                    <tr>
                                                                        <td align="left"><strong>Meses Trabajados:
                                                                            </strong> <?= count($finiquito->detalles) ?>
                                                                        </td>
                                                        ...
                                                        <div class="tabla_borde">
                                                            <table width="100%" border="0" cellpadding="5"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <?php
                                        foreach($finiquito->detalles as $a){
                                       ?>
                                                                    <tr class="border_top">
                                                                        <td align="center">
                                                                            <?= $a->mes ?>
