...
<body class="white-bg">
                ...
                <tr class="border_top">
                    ...
                    <td style="display: none">{{ $de->venta_4 }} </td>
                      ...
                      <td style="display: none">{{ $de->venta_5 }} 
                        ...
                        <td style="display: none">{{ $de->venta_7 }}
                            @if($de->estado_precio_7 == 1)
                                <span style="color: green; font-weight: bold;">(EN USO)</span>
                            @endif </td>
                        <td colspan="2">{{ $de->venta_8 }}                            
    ...
    <div class="tabla_borde">
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                <tr>
                    <th align="center" colspan="9" class="bold"><strong>CLASIFICACION DE PRECIOS POLLO
                            LIMPIO</strong></th>
                </tr>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="0">
                <thead>
                    ...
                    <tr>
                        ...
                        <th align="left"><strong>PRESAS</strong></th>
                        <th align="left"><strong>PRECIO</strong></th>
                ...
                <tbody>
                    ...
                    @foreach ($pollo->items as $item)
                        <tr class="border_top">
                            ...
                            <td align="left" class="bold">{{ $item->name }}</td>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr class="border_top">
                        ...
                        <td><strong>{{ $item->suma_peso }}</strong></td>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr class="border_top">
                        ...
                        <td align="left" class="bold"><strong>{{ $item->precio }}</strong></td>
                    ...
                    @foreach ($item->TransItemDetalles as $i)
                        <tr class="border_top">
                            ...
                            <td align="left" class="bold"><strong>{{ $i->precio }}</strong></td>
