                    ...
                    <div class="tabla_borde">
                        <table width="100%" border="0" height="50" cellpadding="2" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td align="center">
                                        <span style="font-family:Tahoma, Geneva, sans-serif; font-size:19px" text-align="center">L O T E &nbsp; E N &nbsp; P T</span>
                                    </td>
                                </tr>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                ...
                <tr class="border_top">
                    ...
                    <td align="center" colspan="9" class="bold"><strong>COMPO. EXTER. EXTRAIDA</strong></td>
                ...
                foreach ($detalle->PtDetalleDescomposicions()->where('trozado',1)->get() as $des) {
                    $nroTrozado++;
                    $filasTrozado++;
                ?>
                    <tr class="border_top">
                        ...
                        <td align="left">
                            {{$des->CompoExterna->peso}}

                        </td>
                        <td align="left">
                        {{number_format($des->cantidad*$des->CompoExterna->peso,2)}}
                        </td>
