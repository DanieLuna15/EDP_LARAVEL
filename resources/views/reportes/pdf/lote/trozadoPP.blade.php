                    ...
                    <div class="tabla_borde">
                        <table width="100%" border="0" height="50" cellpadding="2" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td align="center">
                                        <span style="font-family:Tahoma, Geneva, sans-serif; font-size:14px" text-align="center">L O T E  &nbsp; D E S C O M P O N E R &nbsp; A &nbsp;P P </span>
                                    </td>
                                </tr>

                                <tr>
                                    <td align="center">
                                        <span style="font-size:14px">DESCOMPONER N° <?= $loteTrozadoPp->id ?> </span>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center" class="bold" colspan="4"><strong> DETALLE DE PP</strong></td>
                ...
                <tr class="border_top">
                    ...
                    <td align="left" class="bold">{{$loteTrozadoPp->ppDetalle->loteDetalle->name}}</td>
                    <td align="left" class="bold">{{$loteTrozadoPp->ppDetalle->cantidad}}</td>
                    <td align="left" class="bold">{{$loteTrozadoPp->ppDetalle->peso_bruto}}</td>
                    <td align="left" class="bold">{{$loteTrozadoPp->ppDetalle->peso_neto}}</td>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center" class="bold" colspan="5"><strong> DETALLE DE DESCOMPOSICION DE PP</strong></td>
                ...
                <tr class="border_top">
                    ...
                    <td align="left" class="bold"><strong>CANTIDAD</strong> </td>
                    <td align="left" class="bold"><strong>PESO</strong></td>
                ...
                $nro = 0;
                $filas = 0;
                foreach ($loteTrozadoPp->ppDetalle->PpDetalleDescomposicions as $detalle) {
                    $nro++;
                    $filas++;
                ?>
                <tr class="border_top">

                    <td align="left" class="bold">{{$detalle->CompoInterna->name}}</td>
                    <td align="left" class="bold">{{$detalle->cantidad}}</td>
                    <td align="left" class="bold">{{$detalle->CompoInterna->peso}}</td>
                    <td align="left" class="bold">{{number_format($detalle->CompoInterna->peso*$detalle->cantidad,2)}}</td>
                    <td align="left" class="bold">{{$detalle->trozado==1?'SIN RETIRAR':'RETIRADO'}}</td>
