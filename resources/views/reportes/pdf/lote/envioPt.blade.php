                    ...
                    <div class="tabla_borde">
                        <table width="100%" border="0" height="50" cellpadding="2" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td align="center">
                                        <span style="font-family:Tahoma, Geneva, sans-serif; font-size:14px" text-align="center">L O T E  &nbsp; E N V I O &nbsp; A &nbsp;P T </span>
                                    </td>
                                </tr>

                                <tr>
                                    <td align="center">
                                        <span style="font-size:14px">ENVIO N° PT <?= $loteEnvioPt->id ?> </span>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center" class="bold" colspan="7"><strong> DETALLE DE ENVIO A PT</strong></td>
                ...
                <tr class="border_top">
                    ...
                    <td align="left" class="bold">{{$loteEnvioPt->loteDetalle->name}}</td>
                    <td align="left" class="bold">{{$loteEnvioPt->ptDetalle->cantidad}}</td>
                    <td align="left" class="bold">{{$loteEnvioPt->ptDetalle->cajas}}</td>
                    <td align="left" class="bold">{{$loteEnvioPt->ptDetalle->peso_bruto}}</td>
                    <td align="left" class="bold">{{$loteEnvioPt->ptDetalle->peso_neto}}</td>
                    <td align="left" class="bold">{{$loteEnvioPt->ptDetalle->merma_bruta}}</td>
                    <td align="left" class="bold">{{$loteEnvioPt->ptDetalle->merma_neta}}</td>
