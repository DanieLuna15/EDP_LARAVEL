                                    ...
                                    <tr>
                                        <td align="center" colspan="4">
                                            <strong><span style="font-size:18px">
                                                    SEGUIMIENTO DE COMPRAS - POR CRONOLOGICO PT/PP
                                                </span></strong>
                                        </td>
                                    </tr>
                                    <tr>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
          ...
          @if($v['tipo'] == 5)
            ...
            @if($v['tipo'] == 2)
                ...
                $t_9  += (float)($tr[9]  ?? 0);
                $t_10 += (float)($tr[10] ?? 0);
                $t_11 += (float)($tr[9]  ?? 0) - (float)($tr[10] ?? 0);

                $t_12 += (float)($tr[12] ?? 0);
                $t_13 += (float)($tr[13] ?? 0);
                $t_14 += (float)($tr[12] ?? 0) - (float)($tr[13] ?? 0);

                $t_15 += $toFloat($tr[15] ?? 0);
                $t_16 += $toFloat($tr[16] ?? 0);
                $t_17 += $toFloat($tr[15] ?? 0) - $toFloat($tr[16] ?? 0);
                @endphp
            @endif
