                    ...
                    <div class="tabla_borde">
                        <table width="100%" border="0" height="50" cellpadding="2" cellspacing="0">
                            <tbody>
                                <tr>
                                    <td align="center">
                                        <span style="font-family:Tahoma, Geneva, sans-serif; font-size:14px" text-align="center">L O T E  &nbsp; T R O Z A R &nbsp; A &nbsp;P T </span>
                                    </td>
                                </tr>

                                <tr>
                                    <td align="center">
                                        <span style="font-size:14px">DESCOMPONER N° <?= $loteTrozadoPt->id ?> </span>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                ...
                <tr class="border_top">
                    ...
                    <td align="left" class="bold">{{$loteTrozadoPt->ptDetalle->loteDetalle->name}}</td>
                    <td align="left" class="bold">{{$loteTrozadoPt->ptDetalle->cantidad}}</td>
                    <td align="left" class="bold">{{$loteTrozadoPt->ptDetalle->peso_bruto}}</td>
                    <td align="left" class="bold">{{$loteTrozadoPt->ptDetalle->peso_neto}}</td>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center" class="bold" colspan="5"><strong> DETALLE DE DESCOMPOSICION DE PT</strong></td>
                ...
                $nro = 0;
                $filas = 0;
                foreach ($loteTrozadoPt->ptDetalle->PtDetalleDescomposicions as $detalle) {
                    $nro++;
                    $filas++;
                ?>
                <tr class="border_top">

                    <td align="left" class="bold">{{$detalle->CompoExterna->name}}</td>
                    <td align="left" class="bold">{{$detalle->cantidad}}</td>
                    <td align="left" class="bold">{{$detalle->CompoExterna->peso}}</td>
                    <td align="left" class="bold">{{number_format($detalle->CompoExterna->peso*$detalle->cantidad,2)}}</td>
                    <td align="left" class="bold">{{$detalle->trozado==0?'SIN RETIRAR':'RETIRADO'}}</td>
