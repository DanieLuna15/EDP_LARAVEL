...
<body class="white-bg">
    ...
    <?php
// --------------------------------------------------------------------------------
// Construcción del arreglo solo con lote_detalles (sin lista_registros)
// --------------------------------------------------------------------------------
foreach ($lote->detalles as $detalle) {
    $registro += 1;

    // Inicialización variables detalle (puedes usar si necesitas)
                                ...
                                <tbody>
                                    <tr>
                                        <td align="center" colspan="4">
                                            <strong><span style="font-size:18px">SEGUIMIENTO DE COMPRAS - POR
                                                    CRONOLOGICO</span></strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="2" align="left"><strong>PAGINA NRO:
                                            </strong>{{ $pagina_actual }}</td>
                                    </tr>
                                    <tr>
            ...
            @foreach ($value as $v)
                ...
                @if ($v['tipo'] == 4)
                    ...
                    <tr class="border_top">
                        ...
                        <td class="bold"></td>
                        <td class="bold"></td>
                        <td class="bold">{{ $tr[9] }}</td>
                        <td class="bold">{{ $tr[10] }}</td>
                        <td class="bold">{{ $tr[11] }}</td>
                        <td class="bold">{{ $tr[12] }}</td>
                        <td class="bold">{{ $tr[13] }}</td>
                        <td class="bold">{{ $tr[14] }}</td>
                        <td class="bold">{{ $tr[15] }}</td>
                        <td class="bold">{{ $tr[16] }}</td>
                        <td class="bold">{{ $tr[17] }}</td>
                    </tr>
                @endif
                @if ($v['tipo'] == 5)
                    @php
...
foreach ($lote->detalles as $detalle) {
    ...
    foreach ($detalle['lista_registros'] as $ld) {
        ...
        $peso_total2 += $peso_total;
        $peso_cajas2 += $peso_cajas;
        $peso_neto2 -= $ld->kg_s;   // igual que en tu código original para lista_registros
