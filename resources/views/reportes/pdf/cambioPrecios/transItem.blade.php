    ...
    @foreach ($transItem as $item)
        ...
        <div class="tabla_borde">
            <table>
                <thead>
                    <tr>
                        <th colspan="9" class="section-title-main">
                            {{ $item->name }}
                        </th>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr class="border_top">
                        ...
                        <th align="left" class="bold"><strong>{{ $item->Item->name }}</strong></th>
                        <th align="left" class="bold"><strong>{{ $item->peso }}</strong></th>
                        <th align="left" class="bold" style="color:red"><strong>{{ $item->precio }}</strong></th>


                        <th align="left" class="bold"><strong>{{ $item->promedio }}</strong></th>
