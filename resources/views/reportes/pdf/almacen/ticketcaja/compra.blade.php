        ...
        <tbody>
            <tr>
                <td style="padding-top:30px !important" class="center bold p-0">
                    {{$compraCaja->sucursal->nombre}}

                </td>
            </tr>
            <tr>
                <td class="center p-0">
                    {{$compraCaja->sucursal->direccion}}

                </td>
            </tr>
            <tr>
                <td class="center p-0">
                    Teléfono: {{$compraCaja->sucursal->telefono}}
            ...
            <tr>
                <td class="center ">
                    <div class="tabla_borde bold">
                        TIPO DE PAGO A {{$compraCaja->tipo==1?'CONTADO':'CREDITO'}}
                    </div>
            ...
            <tr>
                <td class="center p-0 bold ">
                    TICKET DE PAGO DE COMPRA DE CAJAS
                    ...
                    <table width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>{{$compraCaja->fecha}}</td>
                            </tr>
                            <tr>
                                <td class=" p-0 bold " style="width: 100px;">ALMACEN:</td>
                                <td>{{$compraCaja->almacen->name}}</td>
                            </tr>
                            <tr>
                                <td class=" p-0 bold " style="width: 100px;">USUARIO:</td>
                                <td>{{$compraCaja->user->nombre}}</td>
                            </tr>
                            <tr>
