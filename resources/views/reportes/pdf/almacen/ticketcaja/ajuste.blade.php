        ...
        <tbody>
            <tr>
                <td style="padding-top:30px !important" class="center bold p-0">
                    {{$cajaAjuste->sucursal->nombre}}

                </td>
            </tr>
            <tr>
                <td class="center p-0">
                    {{$cajaAjuste->sucursal->direccion}}

                </td>
            </tr>
            <tr>
                <td class="center p-0">
                    Teléfono: {{$cajaAjuste->sucursal->telefono}}
                    ...
                    <table width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>{{$cajaAjuste->fecha}}</td>
                            </tr>
                           
                            <tr>
                                <td class=" p-0 bold " style="width: 100px;">USUARIO:</td>
                                <td>{{$cajaAjuste->user->nombre}}</td>
                            </tr>
                            <tr>
                                <td class=" p-0 bold " style="width: 100px;">NRO DE AJUSTE:</td>
                                <td>{{$cajaAjuste->id}}</td>
                            </tr>
                            <tr>
                                <td class=" p-0 bold " style="width: 100px;">MOTIVO:</td>
                                <td>{{$cajaAjuste->motivo}}</td>
                            </tr>
                            ...
                            <table width="100%" border="0" cellpadding="5" cellspacing="0">
                                <tbody>
                                    ...
                                    <tr class="border_top">
                                        ...
                                        <td align="left"  class="bold">ANTES</td>
                                        ...
                                        <td align="left"class="bold">DESPUES</td>
