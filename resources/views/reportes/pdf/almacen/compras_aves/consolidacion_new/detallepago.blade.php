        ...
        <tr>
            <td width="40%" align="center" style="border:1px solid #ccc; vertical-align:middle;">
                @if (isset($consolidacion->sucursal->image->path_url))
                    <img src="<?= $consolidacion->sucursal->image->path_url ?>" alt="Sucursal Logo"
                        style="width: 80px;">
                @endif
            </td>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                <tr>
                    ...
                    <th align="left" class="bold">PROVEEDOR COMPRA</th>
                    <th align="left" class="bold">NRO LOTE</th>
                ...
                @foreach ($consolidacion->detalles as $de)
                    <tr class="border_top">
                        ...
                        <td align="left" class="">{{ $de->fecha }}</td>
                        <td align="left" class="">
                            {{ $de->proveedor }}</td>
                        <td align="left" class="">{{ $de->nro_lote }}</td>
