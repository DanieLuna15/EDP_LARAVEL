        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                <tr>
                    ...
                    <th colspan="15" class="bold"> <?= $d['categoria']->name ?>
                        COMPRA:{{ $d['compra']->ProveedorCompra->abreviatura }}-{{ $d['compra']->nro_compra }}
                        | LOTE:{{ $d['compra']->nro }} Fecha:{{ $d['compra']->fecha }}</th>
                </tr>
                <tr class="border_top">
                    ...
                    <th align="left" class="bold">T. Pollos</th>
                    <th align="left" class="bold">CBBA</th>
                    <th align="left" class="bold">LP</th>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                <tr>
                    ...
                    <th colspan="9" class="bold">TOTALES</th>
                </tr>
                <tr class="border_top">
                    ...
                    <th align="left" class="bold">Pollos Total </th>
                    <th align="left" class="bold">CBBA Total </th>
                    <th align="left" class="bold">LP Total </th>
                    <th align="left" class="bold">KG Total </th>
                    <th align="left" class="bold">KG Criterio </th>
                    <th align="left" class="bold">KG Criterio Total </th>
                    <th align="center" class="bold">Total de Gastos</th>
                    <th align="left" class="bold">Valor Total Final</th>
                ...
                <tr class="border_top">
                    ...
                    <td align="left" class=""> <?= $consolidacion->detalles->sum('ajuste') ?>
                    </td>
                    <td align="left" class=""> <?= $consolidacion->detalles->sum('lp') ?></td>
                    <td align="left" class="">
