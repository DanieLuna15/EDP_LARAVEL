...
<tr>
            ...
            <td></td>
                ...
                <tr class="border_top">
                    ...
                    <td align="left" style="background-color: #2c3e50;color:white;" class="bold">Pollos</td>
                    <td align="left" style="background-color: #2c3e50;color:white;" class="bold">Peso Bruto</td>
                    <td align="left" style="background-color: #2c3e50;color:white;" class="bold">Cajas</td>
                    ...
                    <td align="left" style="background-color: #2c3e50;color:white;" class="bold">PR-CJ-PB</td>
                    <td align="left" style="background-color: #2c3e50;color:white;" class="bold">Promedio Pollo</td>
                ...
                <tr class="border_top">
                    ...
                    <td style="background-color: #2c3e50;color:white;" align="left" colspan="2" class="bold">Total Pollos</td>
                    <td style="background-color: #2c3e50;color:white;" align="left" class="bold">Total Peso Bruto</td>
                    <td style="background-color: #2c3e50;color:white;" align="left" class="bold">Total CJ</td>
                    ...
                    <td style="background-color: #2c3e50;color:white;" align="left" class="bold">Total PR-CJ-PB</td>
                    <td style="background-color: #2c3e50;color:white;" align="left" class="bold">Total Promedio Pollo</td>
...
foreach ($compra->detalles_sin_cita as $d) {
            ...
            <td></td>
                                    ...
                                    <tr class="border_top">
                                        ...
                                        <td style="background-color: #2c3e50;color:white;" align="left" class="bold">Pollos</td>
                                        <td style="background-color: #2c3e50;color:white;" align="left" class="bold">Peso Bruto</td>
                                        <td style="background-color: #2c3e50;color:white;" align="left" class="bold">Cajas</td>
                                        ...
                                        <td style="background-color: #2c3e50;color:white;" align="left" class="bold">PR-CJ-PB</td>
                                        <td style="background-color: #2c3e50;color:white;" align="left" class="bold">Promedio Pollo</td>
            ...
            <td></td>
                                    ...
                                    <tr class="border_top">
                                        ...
                                        <td style="background-color: #2c3e50;color:white;" align="left" class="bold"> Total Pollos <?= $d['sumaPollos'] ?></td>
            ...
            <td></td>
                                    ...
                                    <tr class="border_top">
                                        ...
                                        <td style="background-color: #b5d2ef;color:black;" align="left" class="bold"> Total Pollos <?= $compra->sum_cant_pollos ?></td>
