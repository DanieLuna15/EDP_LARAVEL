        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                <tr>
                    ...
                    <th align="left " colspan="9" class="bold">Tipo de cinta: <?= $d['sub_original']->name ?>
                        CON PIGMENTO</th>
                </tr>
                <tr class="border_top">
                ...
                <tr class="border_top">
                    ...
                    <td align="left" class=""> {{ format_peso($TotalpromedioPollo) }} </td>
                </tr>
                <tr class="border_top">
                    <th align="left" class="bold" colspan="7"> </th>
                    <th align="left" class="bold"> {{ format_peso($Totalpromedio / $filas) }} </th>
                    <th align="left" class="bold"> {{ format_peso($TotalpromedioPollo / $filas) }} </th>
                </tr>
            </tbody>
        </table>
    </div>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                <tr>
                    ...
                    <th align="left " colspan="9" class="bold">Sumatoria de cinta:
                        <?= $d['sub_original']->name ?></th>
                </tr>
                ...
                <tr class="border_top">
                    <th align="left" class="bold">Total </th>
                    <th align="left" class="bold"colspan="2">Total Pollos</th>
                    <th align="left" class="bold">Total Peso Bruto</th>
                    <th align="left" class="bold">Total CJ</th>
                    <th align="left" class="bold">Total Tara</th>
                    <th align="left" class="bold">Total Peso Neto</th>
                ...
                <tr class="border_top">
                    <td align="left" class=""> {{ $filas }} </td>
                    <td align="left" colspan="2" class=""> {{ (int) $nro }} </td>
                    <td align="left" class=""> {{ format_peso($valor) }} </td>
                    <td align="left" class=""> {{ $cantidad }} </td>
                    <td align="left" class=""> {{ $retraccionSum }} </td>
                    <td align="left" class=""> {{ format_peso($neto) }} </td>
                ...
                <tr class="border_top">
                    <th align="left" class="bold" colspan="7"> </th>
                    <th align="left" class="bold"> {{ number_format($Totalpromedio / $filas, 3) }} </th>
                    <th align="left" class="bold"> {{ number_format($TotalpromedioPollo / $filas, 3) }} </th>
                </tr>
            </tbody>
        </table>
    </div>
...
?>
    <div class="tabla_borde">
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
            <tbody>
                <tr>
                    <th align="left" colspan="4" class="bold">Categoria: <?= $d['categoria']->name ?></th>
                </tr>
                <tr class="border_top">
        ...
        <table width="100%" cellpadding="5" cellspacing="0">
            ...
            <tbody>
                <tr>
                    ...
                    <td><strong>Total Cajas:</strong> <?= $total_cajas ?></td>
