                                ...
                                <table id="table_dt" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr v-for="(m,i) in data">
                                            <td>{{ m . fecha }} #{{ m . id }}</td>
                                            <td>{{ m . consolidacion . compra . nro }}</td>
                                            <td>{{ m . consolidacion . compra . fecha }}</td>
                                            <td>{{ m . user . nombre }}</td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a :href="'./detalle/' + m.id" class="btn btn-warning btn-sm">Editar</a>
                                                    <button type="button"
                                                    ...
                                                    <div class="dropdown-menu" :aria-labelledby="'menu' + i">
                                                        <a :href="m.url_pdf_pt" target="_blank" class="dropdown-item"> PDF</a>
                ...
                methods: {
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/lotes') }}")]).then((v) => {
                                    self.data = v[0]
                                })
