    ...
    @slot('script')
      ...
                    },
                    ...
                    AddPtItem(d, pt) {
                        ...
                        pt_detalle.pt_id = pt.id
                        pt_detalle.nro = pt.nro
                        pt_detalle.peso_bruto_x_caja = Number(pt_detalle.peso_bruto / pt_detalle.cajas).toFixed(3)
                        pt_detalle.peso_neto_x_caja = Number(pt_detalle.peso_neto / pt_detalle.cajas).toFixed(3)
                        pt_detalle.cajas_vender = 1
