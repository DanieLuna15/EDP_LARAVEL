                ...
                methods: {
                    async Save() {
                        try {
                            ...
                            let url = "{{ url('api/tipoNegocios') }}";
                            if (this.add == false) {
                                url = "{{ url('api/tipoNegocios') }}/" + this.model.id
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/tipoNegocios') }}")]).then((v) => {
                                    self.data = v[0]
                                })
                        ...
                        swalWithBootstrapButtons({
                            ...
                            if (result.value) {
                                try {
                                    ...
                                    let url = "{{ url('api/tipoNegocios') }}/" + id
