            ...
            methods: {
                async Save() {
                    try {
                        ...
                        let url = "{{url('api/formaPedidos')}}";
                        if (this.add == false) {
                            url = "{{url('api/formaPedidos')}}/"+this.model.id
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/formaPedidos')}}")]).then((v) => {
                                self.data = v[0]
                            })
                    ...
                    swalWithBootstrapButtons({
                        ...
                        if (result.value) {
                            try {
                                ...
                                let url = "{{url('api/formaPedidos')}}/"+id
