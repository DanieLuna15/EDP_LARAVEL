                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                </svg> Ventas / Tipo Cliente PP Pollo limpio</p>
                        </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" v-model="model.desde" class="form-control"
                                                placeholder="Desde 1 caja">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail4">Hasta</label>
                                            <input type="text" v-model="model.hasta" class="form-control"
                                                placeholder="Hasta 10 cajas">
                                        </div>
                                ...
                                <div class="modal-footer">
                                    <button class="btn brn-danger" data-dismiss="modal"><i class="flaticon-cancel-12"></i>
                                        Cancelar</button>
                ...
                methods: {
                    async Save() {
                        try {
                            ...
                            let url = "{{ url('api/tipoClientePpLimpios') }}";
                            if (this.add == false) {
                                url = "{{ url('api/tipoClientePpLimpios') }}/" + this.model.id
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/tipoClientePpLimpios') }}")]).then((
                                    v) => {
                                    self.data = v[0]
                                })
                        ...
                        swalWithBootstrapButtons({
                            ...
                            if (result.value) {
                                try {
                                    ...
                                    let url = "{{ url('api/tipoClientePpLimpios') }}/" + id
