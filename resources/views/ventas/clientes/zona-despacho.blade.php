                ...
                methods: {
                    async Save() {
                        try {
                            ...
                            let url = "{{ url('api/zonaDespachos') }}";
                            if (this.add == false) {
                                url = "{{ url('api/zonaDespachos') }}/" + this.model.id
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/zonaDespachos') }}")]).then((v) => {
                                    self.data = v[0]
                                })
                        ...
                        swalWithBootstrapButtons({
                            ...
                            if (result.value) {
                                try {
                                    ...
                                    let url = "{{ url('api/zonaDespachos') }}/" + id
