                ...
                methods: {
                    async Save() {
                        try {
                            ...
                            let url = "{{ url('api/tipoClientePps') }}";
                            if (this.add == false) {
                                url = "{{ url('api/tipoClientePps') }}/" + this.model.id
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/tipoClientePps') }}")]).then((v) => {
                                    self.data = v[0]
                                })
                        ...
                        swalWithBootstrapButtons({
                            ...
                            if (result.value) {
                                try {
                                    ...
                                    let url = "{{ url('api/tipoClientePps') }}/" + id
