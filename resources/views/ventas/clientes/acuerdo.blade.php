                    ...
                    <div class="modal-body">
                        <div class="form-row mb-4">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" v-model="model.cantidad" class="form-control" placeholder="">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="inputEmail4">Peso</label>
                                <input type="text" v-model="model.peso" class="form-control" placeholder="">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="inputEmail4">Precio</label>
                                <input type="text" v-model="model.precio" class="form-control" placeholder="">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="inputEmail4">Digitar Peso</label>
                                <select name="" class="form-control " v-model="model.digitar" id="">
            ...
            methods: {
                async Save() {
                    try {
                        ...
                        let url = "{{url('api/acuerdoClientes')}}";
                        if (this.add == false) {
                            url = "{{url('api/acuerdoClientes')}}/"+this.model.id
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/acuerdoClientes')}}")]).then((v) => {
                                self.data = v[0]
                            })
                    ...
                    swalWithBootstrapButtons({
                        ...
                        if (result.value) {
                            try {
                                ...
                                let url = "{{url('api/acuerdoClientes')}}/"+id
