                    ...
                    <div class="modal-body">
                        <div class="form-row mb-4">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" v-model="model.desde" class="form-control" placeholder="Desde 1 caja">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="inputEmail4">Hasta</label>
                                <input type="text" v-model="model.hasta" class="form-control" placeholder="Hasta 10 cajas">
                            </div>
            ...
            methods: {
                async Save() {
                    try {
                        ...
                        let url = "{{url('api/cajacerradaClientes')}}";
                        if (this.add == false) {
                            url = "{{url('api/cajacerradaClientes')}}/"+this.model.id
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/cajacerradaClientes')}}")]).then((v) => {
                                self.data = v[0]
                            })
                    ...
                    swalWithBootstrapButtons({
                        ...
                        if (result.value) {
                            try {
                                ...
                                let url = "{{url('api/cajacerradaClientes')}}/"+id
