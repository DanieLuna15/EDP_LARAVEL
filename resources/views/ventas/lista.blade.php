                                ...
                                <table id="table_dt" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr v-for="(m,i) in data">
                                            ...
                                            <td>{{ m.venta_caja.cajas }}</td>
                                            <td>{{ m . total }}</td>
                                            <td>{{ m . pagado_total }}</td>
                                            <td>
                                                <span v-if ="m.estado==1" class="badge badge-success">VIGENTE</span>
                                                    ...
                                                    <div class="dropdown-menu" :aria-labelledby="'menu' + i">
                                                     ...
                                                     <a :href="'./compras/edit/' + m.id" class="dropdown-item">Editar</a> -->
                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                            @click="deleteItem(m.id)">ANULAR VENTA</a>
                                                    </div>
                ...
                methods: {
                    ...
                    async ConsultarFecha() {
                        ...
                        try {
                            ...
                            let res = await axios.post("{{ url('api/ventaFecha') }}", data).then((v) => {
                                self.data = v.data
                            })
                            dt.create()
                            block.unblock();
