                                ...
                                <div class="modal-body">
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" v-model="model.monto" class="form-control" placeholder="0.30">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail4">Desde</label>
                                            <input type="text" v-model="model.desde" class="form-control"
                                                placeholder="Desde 10 cajas">
                                        </div>
                ...
                methods: {
                    async Save() {
                        try {
                            ...
                            let url = "{{ url('api/tipoclientes') }}";
                            if (this.add == false) {
                                url = "{{ url('api/tipoclientes') }}/" + this.model.id
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/tipoclientes') }}")]).then((v) => {
                                    self.data = v[0]
                                })
                        ...
                        swalWithBootstrapButtons({
                            ...
                            if (result.value) {
                                try {
                                    ...
                                    let url = "{{ url('api/tipoclientes') }}/" + id
