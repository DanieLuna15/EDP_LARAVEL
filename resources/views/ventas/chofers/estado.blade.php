            ...
            methods: {
                async Save() {
                    try {
                        ...
                        let url = "{{url('api/estadoCompraChofers')}}";
                        if (this.add == false) {
                            url = "{{url('api/estadoCompraChofers')}}/"+this.model.id
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/estadoCompraChofers')}}")]).then((v) => {
                                self.data = v[0]
                            })
                    ...
                    swalWithBootstrapButtons({
                        ...
                        if (result.value) {
                            try {
                                ...
                                let url = "{{url('api/estadoCompraChofers')}}/"+id
