                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail4">Peso Inicio</label>
                                            <input type="text" v-model="model.inicio" class="form-control" placeholder="0.30">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail4">Peso Fin</label>
                                            <input type="text" v-model="model.fin" class="form-control" placeholder="0.40">
                                        </div>
                ...
                methods: {
                    async Save() {
                        try {
                            ...
                            let url = "{{ url('api/cintaClientes') }}";
                            if (this.add == false) {
                                url = "{{ url('api/cintaClientes') }}/" + this.model.id
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/cintaClientes') }}")]).then((v) => {
                                    self.data = v[0]
                                })
                        ...
                        swalWithBootstrapButtons({
                            ...
                            if (result.value) {
                                try {
                                    ...
                                    let url = "{{ url('api/cintaClientes') }}/" + id
