                    ...
                    <div class="modal-body">
                        <div class="form-row mb-4">
                            ...
                            <div class="form-group col-md-12">
                               ...
                               <select name="" id="" v-model="model.user_id" class="form-control">
                    ...
                    <table id="table_dt" class="table table-hover non-hover" style="width:100%">
                        ...
                        <tbody>
                            <tr v-for="(m,i) in data.caja_sucursal_usuarios">
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button @click="deleteItem(m.id)" type="button" class="btn btn-dark btn-sm">Eliminar</button>
            ...
            methods: {
                async Save() {
                    try {
                        ...
                        this.model.caja_sucursal_id = this.data.id
