        ...
        <div class="page-header">
            <div class="page-title">
                <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid">
                    ...
                    </svg> Cajas / Lista de transacciones</p>
            </div>
            ...
            methods: {
                async Save() {
                    try {
                        ...
                        let url = "{{url('api/cajaMotivos')}}";
                        if (this.add == false) {
                            url = "{{url('api/cajaMotivos')}}/"+this.model.id
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/cajaMotivos')}}"),
                    ...
                    swalWithBootstrapButtons({
                        ...
                        if (result.value) {
                            try {
                                ...
                                let url = "{{url('api/cajaMotivos')}}/"+id
