                                ...
                                <div class="modal-body">
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" v-model="model.name" class="form-control" placeholder="10 Ctvos">
                                        </div>
                                    ...
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" v-model="model.valor" class="form-control" placeholder="0.10">
                                        </div>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" :aria-labelledby="'menu' + i">
                                                        <a class="dropdown-item" :href="'/cajas/moneda/image/' + m.id">Imagen</a>
                ...
                methods: {
                    async Save() {
                        try {
                            ...
                            let url = "{{ url('api/monedas') }}";
                            if (this.add == false) {
                                url = "{{ url('api/monedas') }}/" + this.model.id
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/monedas') }}")]).then((v) => {
                                    self.data = v[0]
                                })
