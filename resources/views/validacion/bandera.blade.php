                    ...
                    <div class="modal-body">
                        <div class="form-row mb-4">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" v-model="model.name" class="form-control" placeholder="color">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="inputEmail4">Min</label>
                                <input type="text" v-model="model.min" class="form-control" placeholder="Min">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="inputEmail4">Max</label>
                                <input type="text" v-model="model.max" class="form-control" placeholder="Max">
                            </div>
            ...
            methods: {
                async Save() {
                    try {
                        ...
                        let url = "{{url('api/banderas')}}";
                        if (this.add == false) {
                            url = "{{url('api/banderas')}}/"+this.model.id
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/banderas')}}")]).then((v) => {
                                self.data = v[0]
                            })
