            ...
            methods: {
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/cambioPreciosFecha')}}")]).then((v) => {
                                self.data = v[0]
                            })
                ...
                async ConsultarFecha(){
                    ...
                    try {
                        ...
                        dt.destroy()
                        let res = await axios.post("{{url('api/cambioPreciosFecha')}}",data).then((v) => {
                                self.data = v.data
                            })
