                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                </svg> Reportes / Planillas Servicios</p>
                        </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="input-group mb-4">
                                        <select v-model="contrato_id" class="form-control">
                                            ...
                                            <template v-for="(m,i) in contratos">
                                                <option v-if="m.servicio==2" :value="m.id">{{ m . persona . nombre }}</option>
            ...
            createApp({
                ...
                methods: {
                    async Consultar() {
                        ...
                        try {
                            dt.destroy()
                            await Promise.all([self.GET_DATA('api/reportes/contratos/planillaservicios/' + this
                                .contrato_id)]).then((v) => {
