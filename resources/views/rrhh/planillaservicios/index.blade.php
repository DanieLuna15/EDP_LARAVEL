            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalCargaMasivaLabel">Carga Masiva de Planillas Servicio</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('planillasservicio.downloadTemplate') }}" target="_blank" class="btn btn-dark">
                            Descargar Plantilla
                        </a>
                    </div>
                </div>
                ...
                methods: {
                    ...
                    async load() {
                        try {
                            ...
                            try {
                                await Promise.all([self.GET_DATA("{{ url('api/planillaservicios') }}")]).then((
                                    v) => {
                                    self.data = v[0]
                                })
                    ...
                    async submitFile() {
                        ...
                        try {
                            const res = await axios.post(
                                '{{ route('planillasservicio.import') }}',
                                form, {
                                    headers: {
