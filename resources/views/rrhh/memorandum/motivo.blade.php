            ...
            methods: {
                async Save() {
                    try {
                        ...
                        let url = "{{url('api/motivomemorandums')}}";
                        if (this.add == false) {
                            url = "{{url('api/motivomemorandums')}}/"+this.model.id
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/motivomemorandums')}}")]).then((v) => {
                                self.data = v[0]
                            })
                    ...
                    swalWithBootstrapButtons({
                        ...
                        if (result.value) {
                            try {
                                ...
                                let url = "{{url('api/motivomemorandums')}}/"+id
