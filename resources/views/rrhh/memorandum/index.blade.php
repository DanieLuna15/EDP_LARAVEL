        ...
        <div class="page-header">
            <div class="page-title">
                <p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid">
                    ...
                    </svg> RRHH / Memorandum</p>
            </div>
            <a href="./memorandums/add" class="btn btn-success">Agregar</a>
        </div>
            ...
            <table id="table_dt" class="table table-hover non-hover" style="width:100%">
              ...
              <tbody>
                <tr v-for="(m,i) in data">
                  ...
                  <td>{{m.motivomemorandum.name}}</td>

                  <td>{{m.fecha}}</td>

                  <td>
                    <div class="btn-group">
                      <a :href="m.url_pdf" class="btn btn-success btn-sm" target="_blank">PDF</a>
            ...
            methods: {
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/memorandums')}}")]).then((v) => {
                                self.data = v[0]
                            })
