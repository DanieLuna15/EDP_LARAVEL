        ...
        <div class="row justify-content-center">
                ...
                <div class="info">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4 col-6">
                      <div class="form-group">
                        <label for="fullName">Finiquito desde</label>
          ...
          <div v-if="personaValidate" class="col-sm-6 col-12 mt-4">
            <div class="widget-content widget-content-area br-6">
              <div class="section general-info">
                <div class="info">
                  <h6 class="">Finiquito Vacacional</h6>
                  <div class="row">
                    ...
                    <div class="col-sm-8 col-12">
                      ...
                      <div class="form-group ">
                        <label>Estado</label>
                        <input type="text" :value="contrato.planilla_lista.length<12?'NO APTO PARA VACACIONES':'APTO PARA VACACIONES'" disabled class="form-control mb-4" placeholder="">
                      </div>
                    </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-12">
                          ...
                          <div class="form-group ">
                            ...
                            <input type="text" :value="parseInt(contrato.planilla_lista.length/12)" class="form-control mb-4" disabled placeholder="">
                          </div>
                        </div>
                        <div class="col-sm-6 col-12">
                          ...
                          <div class="form-group ">
                            <label>Finiquito Desde</label>
                            <input type="text" :value="contrato.planilla_lista[0].desde" class="form-control mb-4" disabled placeholder="">

                          </div>
                        </div>
                        <div class="col-sm-6 col-12" v-if="parseInt(contrato.planilla_lista.length/12)>1">


                          <div class="form-group ">
                            <label>Finiquito Hasta</label>
                            <input type="text" :value="contrato.planilla_lista[(parseInt(contrato.planilla_lista.length/12)*12)].hasta" class="form-control mb-4" disabled placeholder="">
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-12 col-6">
                      ...
                      <div class="form-group ">
                        <label>Mandar a planilla</label>
                        <select v-model="planilla_estado" class="form-control">

                          <option :value="1">Mandar</option>
                          <option :value="2">No Mandar</option>
                    ...
                    <div class="col-sm-12 col-6">
                      ...
                      <div class="form-group ">
                        <label>Calculo de vacaciones</label>
                        <select v-model="parametrovacacion" class="form-control">

                          <option v-for="(m,i) in parametrovacacions" :value="m">{{m.desde}}-{{m.hasta}} años</option>
                    ...
                    <div class="col-12 text-center">
                      ...
                      <h2>{{Number((contrato.sueldo/contrato.cog_planilla.dias_base)*Number(parametrovacacion.dias)).toFixed(2)}}</h2>
                    </div>
    ...
    methods: {
      ...
      async save() {
        ...
        try {
          ...
          this.model.planilla_estado = this.planilla_estado
          this.model.pago = Number((this.contrato.sueldo / this.contrato.cog_planilla.dias_base) * Number(this.parametrovacacion.dias))
          this.model.fecha_inicio = this.contrato.inicio
          this.model.fechaInicio = this.contrato.planilla_lista[(parseInt(this.contrato.planilla_lista.length/12)*12)-1].hasta
          this.model.fecha_fin = this.contrato.inicio_add
          this.model.planillas = this.rangeArray(this.contrato.planilla_lista,(parseInt(this.contrato.planilla_lista.length/12)*12)-1)
          const params = new URLSearchParams(this.model);
          let url = "{{url('api/finivacacionals')}}";
    ...
    mounted() {
      this.$nextTick(async () => {
        ...
        try {
          ...
          await Promise.all([self.GET_DATA('api/contratos-finivacacionals'), self.GET_DATA('api/tipocontratos'), self.GET_DATA('api/areas'), self.GET_DATA('api/costovariables'), self.GET_DATA('api/parametrovacacions')]).then((v) => {
            self.contratos = v[0]
            self.tipocontratos = v[1]
            self.areas = v[2]
            self.costovariables = v[3]
            self.parametrovacacions = v[4]
          })
