      ...
      <div class="row justify-content-center">
              ...
              <div class="info">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4 col-6">
                    <div class="form-group">
                      <label for="fullName">Inicio</label>
                  ...
                  <div class="col-12 text-center">
                    ...
                    <h2>{{Number(this.contrato.sueldo).toFixed(2)}}</h2>
                  </div>
                  <div class="col-12 text-center">
                      <hr>
        ...
        <div v-if="personaValidate" class="col-sm-6 col-12 mt-4">
          <div class="widget-content widget-content-area br-6">
            <div class="section general-info">
              <div class="info">
                <h6 class="">Finiquito Quinquenio</h6>
                <div class="row">
                  ...
                  <div class="col-sm-8 col-12">
                    ...
                    <div class="form-group ">
                      <label>Estado</label>
                      <input type="text" :value="contrato.planilla_lista.length<60?'NO APTO PARA FINIQUITO QUINQUENIO':'APTO PARA FINIQUITO QUINQUENIO'" disabled class="form-control mb-4" placeholder="">
                    </div>
                  </div>
                  ...
                  <div class="col-12 text-center">
                    ...
                    <h2>{{Number((contrato.sueldo*contrato.planilla_lista.length)/12).toFixed(2)}}</h2>
                  </div>
                  <div v-if="contrato.planilla_lista.length>=60" class="col-sm-12 col-12 mb-4">
...
<script type="module">
  ...
  createApp({
    ...
    computed: {
      ...
      SueldoBruto() {
        return Number(this.contrato.sueldo) / Number(Number(Number(this.contrato.contratocostos_sum) / 100) + 1)
      },
      SumCostos() {
      ...
      ValorBrutoPago() {
        ...
        return this.this.contrato.sueldo + valor + this.SumCostos - this.PagosDeudaValor
      }
    },
    methods: {
      Crear() {
      ...
      async save() {
        ...
        try {
          ...
          this.model.pago = (this.this.contrato.sueldo * this.contrato.planilla_lista.length) / 12
          this.model.fecha = this.contrato.planilla_lista[0].fecha
          this.model.user_id = this.user_id
          this.model.planillas = this.contrato.planilla_lista

          let url = "{{url('api/finiquinquenios')}}";
    ...
    mounted() {
      this.$nextTick(async () => {
        ...
        try {
          ...
          await Promise.all([self.GET_DATA('api/contratos-finiquinquenios'), self.GET_DATA('api/tipocontratos'), self.GET_DATA('api/areas'), self.GET_DATA('api/costovariables')]).then((v) => {
            self.contratos = v[0]
