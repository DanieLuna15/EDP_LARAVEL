            ...
            <div class="modal-body">
              <div class="form-row mb-4">
                ...
                <div class="form-group col-md-12">
                  ...
                  <input type="text" v-model.number="model.monto" class="form-control" placeholder="Monto">
                </div>
            ...
            methods: {
                async Save() {
                    try {
                        ...
                        let url = "{{url('api/costofijos')}}";
                        if (this.add == false) {
                            url = "{{url('api/costofijos')}}/"+this.model.id
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/costofijos')}}")]).then((v) => {
                                self.data = v[0]
                            })
