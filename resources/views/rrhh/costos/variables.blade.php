            ...
            methods: {
                async Save() {
                    try {
                        ...
                        let url = "{{url('api/costovariables')}}";
                        if (this.add == false) {
                            url = "{{url('api/costovariables')}}/"+this.model.id
                ...
                async load() {
                    try {
                        ...
                        try {
                            await Promise.all([self.GET_DATA("{{url('api/costovariables')}}")]).then((v) => {
                                self.data = v[0]
                            })
                    ...
                    swalWithBootstrapButtons({
                        ...
                        if (result.value) {
                            try {
                                ...
                                let url = "{{url('api/costovariables')}}/"+id
