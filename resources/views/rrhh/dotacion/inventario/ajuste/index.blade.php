        ...
        <div class="page-header">
            <div class="page-title">
                <p>
                    ...
                    Ajustes de dotaciones
                </p>
            </div>
            <div class="btn-group" role="group" aria-label="Basic example">
                <a href="./ajustes/add" class="btn btn-success">Agregar</a>
        ...
        methods: {
            ...
            async load() {
                try {
                    ...
                    try {
                        await Promise.all([self.GET_DATA("{{url('api/ajustedotacions/sucursal')}}/"+this.sucursal.id)]).then((v) => {
                            self.data = v[0]
                        })
