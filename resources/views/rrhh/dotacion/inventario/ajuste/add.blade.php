            ...
            <div class="card component-card_4">
              <div class="card-body">
                ...
                <div class="user-info">
                  ...
                  <button @click="Agregar(m)" class="btn btn-dark mt-4 btn-sm w-100">AJUSTAR</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="media m-0">
            ...
            <div class="media-body">
              ...
              <div class="btn-group" role="group" aria-label="Basic example">
                  ...
                  Stock {{Number(m.dotacion.stock+m.cantidad)}}
                  </button>
                  <button type="button"  @click="m.cantidad--" :disabled="m.dotacion.stock+m.cantidad<1" class="btn btn-dark">
      ...
      <div class=" col-12 layout-spacing">
        <div class="widget-three">
          <div class="widget-content">
            ...
            <button @click="Save()" class="btn btn-block btn-primary mt-4"> GUARDAR AJUSTE </button>
          </div>
        </div>
      </div>
    </div>
    ...
    methods: {
      ...
      async Save() {
        try {
          ...
          let url = "{{url('api/ajustedotacions')}}";
