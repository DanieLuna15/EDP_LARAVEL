        ...
        <div class="page-header">
            <div class="page-title">
                <p>
                    ...
                    Traspaso de dotaciones
                </p>
            </div>
            <div class="btn-group" role="group" aria-label="Basic example">
                <a href="./traspasos/add" class="btn btn-success">Agregar</a>
            ...
            <table id="table_dt" class="table table-hover non-hover" style="width:100%">
              ...
              <tbody>
                <tr v-for="(m,i) in data">
                  ...
                  <td>{{m.sucursal_destino.nombre}}</td>
                  <td>{{m.fecha}}</td>
                  <td>{{m.user.nombre}}</td>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <a :href="m.url_pdf" class="dropdown-item" target="_blank">PDF A4</a>
                      <a :href="m.url_ticket_pdf" class="dropdown-item" target="_blank">PDF TICKET</a>
        ...
        methods: {
            ...
            async load() {
                try {
                    ...
                    try {
                        await Promise.all([self.GET_DATA("{{url('api/traspasoDotacions/sucursal')}}/"+this.sucursal.id)]).then((v) => {
                            self.data = v[0]
                        })
