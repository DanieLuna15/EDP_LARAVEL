        ...
        <div class="page-header">
            <div class="page-title">
                <p>
                    ...
                    Salida de dotacion por personal
                </p>
            </div>
            <div class="btn-group" role="group" aria-label="Basic example">
                <a href="./salidacontratos/add" class="btn btn-success">Agregar</a>
                ...
                <tr v-for="(m,i) in data">
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <button type="button" class="btn btn-warning btn-sm dropdown-toggle dropdown-toggle-split" :id="'menu'+i" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-reference="parent">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down">
                          <polyline points="6 9 12 15 18 9"></polyline>
                        </svg>
                      </button>
                      <div class="dropdown-menu" :aria-labelledby="'menu'+i">
                        <a class="dropdown-item" :href="'./salidacontratos/edit/'+m.id" >Devolucion</a>
                        <a class="dropdown-item" :href="'./salidacontratos/redotacion/'+m.id" >Redotacion</a>
        ...
        methods: {
            ...
            async load() {
                try {
                    ...
                    try {
                        await Promise.all([self.GET_DATA("{{url('api/salidadotacioncontratos')}}")]).then((v) => {
                            self.data = v[0]
                        })
