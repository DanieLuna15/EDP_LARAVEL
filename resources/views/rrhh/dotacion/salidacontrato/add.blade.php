                ...
                <div class="card component-card_4">
                  <div class="card-body">
                    ...
                    <div class="user-info">
                      ...
                      <button @click="Agregar(m)"  :disabled="m.cantidad<=0"   class="btn btn-dark mt-4 btn-sm w-100">SALIDA</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="media m-0">
                ...
                <div class="media-body">
                  ...
                  <p class="media-text">
                    ...
                    <span class="badge badge-success mr-2">Stock {{Number(m.dotacion.stock).toFixed(2)}}</span>
                  ...
                  <div class="btn-group" role="group" aria-label="Basic example">
                      ...
                      <button type="button" @click="m.cantidad++" :disabled="m.cantidad>=m.dotacion.stock" class="btn btn-dark">
            ...
            <div class="widget-three">
              <div class="widget-content">
                ...
                <div class="form-group col-md-12">
                  <label for="inputEmail4">Personal</label>
                  <select v-model="model.contrato_id" name="" class="custom-select" id="">
                    <option v-for="(m,i) in contratos" :value="m.id">{{m.persona.nombre}}</option>
                  </select>
                </div>

                </div>
                <button @click="Save()" class="btn btn-block btn-primary mt-4"> GUARDAR SALIDA </button>
              </div>
            </div>
          </div>
        </div>
    ...
    methods: {
      ...
      async Save() {
        try {
          ...
          let url = "{{url('api/salidadotacioncontratos')}}";
      ...
      async load() {
        try {
          ...
          try {
            await Promise.all([self.GET_DATA('api/stockdotacions/sucursal/1'), self.GET_DATA('api/contratos')]).then((v) => {
              self.data = v[0]
              self.contratos = v[1]
            })
