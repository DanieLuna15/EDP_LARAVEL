      ...
      <div class="page-header">
        <div class="page-title">
          <p>
            ...
            Salida de dotacion clientes
          </p>
        </div>
        <div class="btn-group" role="group" aria-label="Basic example">
        <a href="./salidacliente/add" class="btn btn-success">Agregar</a>
</div>
            ...
            <table id="table_dt" class="table table-hover non-hover" style="width:100%">
              ...
              <tbody>
                <tr v-for="(m,i) in data">
                  ...
                  <td>
                    <div class="btn-group">
                      <a   :href="m.url_pdf" class="btn btn-dark btn-sm" target="_blank">Ver</a>
        ...
        methods: {
            ...
            async load() {
                try {
                    ...
                    try {
                        await Promise.all([self.GET_DATA("{{url('api/salidadotaclientes')}}")]).then((v) => {
                            self.data = v[0]
                        })
