            ...
            <div class="card component-card_4">
              <div class="card-body">
                ...
                <div class="user-info">
                  ...
                  <button @click="Agregar(m)"  :disabled="m.cantidad<=0"   class="btn btn-dark mt-4 btn-sm w-100">AJUSTAR</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="widget-three">
          <div class="widget-content">
            ...
            <div class="form-group col-md-12">
              ...
              <select v-model="model.cliente_id" name="" class="custom-select" id="">
                <option v-for="(m,i) in clientes" :value="m.id">{{m.nombre}}</option>
              </select>
            </div>
    ...
    methods: {
      ...
      async Save() {
        try {
          ...
          let url = "{{url('api/salidadotaclientes')}}";
      ...
      async load() {
        try {
          ...
          try {
            await Promise.all([self.GET_DATA('api/stockdotacions/sucursal/1'), self.GET_DATA('api/clientes')]).then((v) => {
              self.data = v[0]
              self.clientes = v[1]
            })
