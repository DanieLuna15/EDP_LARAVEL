...
class CreateCambioPrecioConsolidacionAvesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cambio_precio_consolidacion_aves', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('cambio_precio_consolidacion_aves');
    }
}