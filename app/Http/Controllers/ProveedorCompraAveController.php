...
class ProveedorCompraAveController extends Controller
{
    /**
    ...
    {
        return ProveedorCompra::with(['Documento', 'Categoria', 'ProveedorCompraMedidas'])->where([['estado', 1], ['inactivo', 1], ['tipo', 2]])->get();
    }
    public function inactivos()
    {
        return ProveedorCompra::with(['Documento', 'Categoria', 'ProveedorCompraMedidas'])->where([['estado', 1], ['inactivo', 0], ['tipo', 2]])->get();
    }
    ...
    {
        $proveedorCompra = ProveedorCompra::findOrFail($id);
    ...
    public function destroy($id)
    {
        ...
        $proveedorCompra->save();
        return response()->json(['message' => 'Proveedor desactivado correctamente'], 200);
    }
}
