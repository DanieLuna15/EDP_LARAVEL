...
class Lote extends Model
{
    ...
    public function Compra(){
        return $this->belongsTo(Compra::class)->with(['Sucursal','ProveedorCompra']);
    }
    public function LoteDetalles(){
        return $this->hasMany(LoteDetalle::class)->with(['PpDetalles','LoteDetalleMovimientos','LoteDetalleProductos'])->where('estado',1);
    }
